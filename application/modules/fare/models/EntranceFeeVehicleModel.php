...
/**
 * -----------------------
 * CLASS NAME : EntranceFeeVehicleModel
 * -----------------------
 *
...
class EntranceFeeVehicleModel extends MY_Model{
    ...
    public function dataList(){
		...
		{
			$where .=" and  tmefp.vehicle_class_id={$vehicleClass} ";
		}		
		...
		$sql 		   = "
								...
								tmsc.name as vehicle_class_name
							from app.t_mtr_entrance_fee_vehicle tmefp 
							join app.t_mtr_port tmp on tmefp.port_id = tmp.id
							join app.t_mtr_vehicle_class tmsc on tmefp.vehicle_class_id  =tmsc.id
							{$where}
						 ";
