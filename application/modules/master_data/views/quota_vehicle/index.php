                        ...
                        <div class="row">
                            <div class="col-md-12"> 
                                ...
                                <div class="input-group select2-bootstrap-prepend">
                                    ...
                                    <select id="ship_class" class="form-control js-data-example-ajax select2" dir="" name="ship_class">
                                        <option value="">Pilih</option>
                                ...
                                <div class="input-group select2-bootstrap-prepend">
                                    <div class="input-group-addon">Tipe Kendaraan</div>
                                    <select id="vehicle_type" class="form-control js-data-example-ajax select2" dir="" name="vehicle_type">
                                        <option value="">Pilih</option>
...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('master_data/quota_vehicle') ?>",
                "type": "POST",
                "data": function(d) {
                    d.port = document.getElementById('port').value;
                    d.ship_class = document.getElementById('ship_class').value;
                    d.vehicle_type = document.getElementById('vehicle_type').value;
                },
            },
            ...
            "columns": [
                    ...
                    {"data": "vehicle_type_name", "orderable": true, "className": "text-center"},
