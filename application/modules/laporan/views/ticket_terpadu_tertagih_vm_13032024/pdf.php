...
<page backtop="30mm" backbottom="0mm" backleft="7mm" backright="7mm">
	...
	<table class="tabel full-width" align="center">
		...
		<tr>
			...
			<td style="border-right: none !important;width: 25%">STATUS</td>
      		<td style="border-left: none !important;width: 25%">: <b><?=strtoupper($status_approve) ?></b></td>
		</tr>
	</table>
	...
	<table class="tabel full-width" style="width: 100% !important">
		<tr>
			<th colspan="6" style="width: 100%">TIPE PENJUALAN : VENDING MACHINE</th>
		</tr>
		<tr>
			<td style="text-align: center;width: 5% !important"> No </td>
			<td style="text-align: center;width: 25% !important"> Nama Perangkat </td>
			<td style="text-align: center;width: 10% !important"> Jenis </td>
			<td style="text-align: center;width: 10% !important"> Tarif (Rp.) </td>
			<td style="text-align: center;width: 20% !important"> Produksi (Lbr) </td>
			<td style="text-align: center;width: 20% !important"> Pendapatan (Rp.) </td>
		</tr>
		<?php
			$angka = 1;
			$produksi_vm = 0;
		...
		<tr>
			...
			<td style="text-align: left"> <?= wordwrap( $value->terminal_name, 31, '<br />', true) ?> </td>
		...
		<tr>
			...
			<td style="text-align: right"><b><?=idr_currency($produksi_vm) ?></b></td>
			<td style="text-align: right"><b><?=idr_currency($pendapatan_vm) ?></b></td>
		</tr>
		<tr>
			<td colspan="4" style="border-right: 0px;"><b>TOTAL JUMLAH (VM)</b></td>
			<td style="text-align: right"><b><?=idr_currency($produksi_vm) ?></b></td>
			<td style="text-align: right"><b><?=idr_currency($pendapatan_vm) ?></b></td>
		</tr>
	</table><br>
...
$filename = strtoupper("Tiket_tertagih_vm_" . $pelabuhan . "_". $tanggal . "_" . strtoupper($this->input->get("ship_classku")) ."_". $shift);
try
{
	// setting paper
