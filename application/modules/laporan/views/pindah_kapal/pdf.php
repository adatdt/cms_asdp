...
<page backtop="30mm" backbottom="10mm" backleft="8mm" backright="8mm">
		...
		<table class="tabel full-width" align="center" style="width: 100%">
            <tr style="width: 100%">
                ...
                <td rowspan="4" class="center bold" style="width: 42%;font-size:14px; line-height: 1.5; vertical-align: middle">
                    LAPORAN REKAPITULASI<br>PINDAH KAPAL
                </td>
	...
	<table class="tabel full-width" align="center">
		...
		<tr>
			<td style="border-right: none !important;width: 25%">KAPAL AWAL</td>
			<td style="border-left: none !important;width: 25%">: <?=$ship_origin ?></td>
			<td style="border-right: none !important;width: 25%">KAPAL TUJUAN</td>
			<td style="border-left: none !important;width: 25%">: <?=$ship_destination ?></td>
		</tr>
	</table>
	...
	<table class="tabel full-width" style="width: 100% !important">
		<tr>
			...
			<td style="text-align: center"> Jenis Tiket</td>
		...
		<tr>
			<td colspan="2" style="border-right: 0px;"><b>Total Jumlah (Penumpang + Kendaraan) </b></td>
...
$filename = strtoupper("Laporan_pindah_kapal_" . $pelabuhan . "_". $tanggal . "_" . $this->input->get("ship_classku"));
try
{
  // setting paper
