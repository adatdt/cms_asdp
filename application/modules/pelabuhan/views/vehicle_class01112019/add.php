                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="number" name="min" class="form-control angka" onkeypress="return isNumberKey(event)" placeholder="Panjang Minimum" required>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="number" name="max" class="form-control angka" onkeypress="return isNumberKey(event)" placeholder="Panjang Maximum" required>
                        </div>

                        <div class="col-sm-4">
                            <label>Kapasitas Maximum Penumpang <span class="wajib">*</span></label>
                            <input type="number" name="capacity_maximum" class="form-control angka" onkeypress="return isNumberKey(event)" placeholder="Maximum Penumpang" required>
                        </div>

                        <div class="col-sm-4">
                            <label>Berat Maximum <span class="wajib">*</span></label>
                            <input type="number" name="weight_maximum" class="form-control angka" onkeypress="return isNumberKey(event)" placeholder="Berat Maximum" required>
                        </div>
