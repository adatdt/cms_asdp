...
<script>
    ...
    function chartLine(data, id_item) {
        ...
        var colors = ['#0073c8', '#FFA500', '#999','#8a2be2','#f44336','#FFD700'];
        ...
        var option = {
            ...
            tooltip: {
                ...
                formatter: function(params, c) {
                    ...
                    var colorSpan = color => '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:9px;height:9px;z-index:1;background-color:' + color + '"></span>';
                    let rez = '<h5 style="font-weight:bold; text-align: center;">Pukul ' + params[0].name + '</h5>';
                        ...
                        rez += `<div style="margin-bottom:0;" class="tltpReservasi">
                                ...
                                ${rezReservasi}
                                <h5 style="font-weight:bold; text-align: center;"><?php echo $detail ?></h5>
                                </ul>
                                </div>`;
                    ...
                    // rez += `<h5 style="font-weight:bold; text-align: center;"><?php echo $detail ?></h5>`;
