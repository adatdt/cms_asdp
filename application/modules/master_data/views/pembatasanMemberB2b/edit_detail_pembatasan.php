...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('master_data/pembatasanMemberB2b/action_edit_detail_pembatasan', 'id="ff" autocomplete="off"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" readonly name="merchant_id" class="form-control" required placeholder="Nama Merchant" value="<?= $detail->merchant_id?>" >                        
                        </div>  

                        <div class="col-sm-4 form-group">
                            <label>Outlet ID<span class="wajib">*</span></label> 
                            <input type="text" readonly name="outlet_id" class="form-control" required placeholder="Outlet ID" value="<?= $detail->outlet_id?>" >                        
                            <input type="hidden" readonly name="idDetail"  required  value='<?= $id ?>'> 
                        </div>                
