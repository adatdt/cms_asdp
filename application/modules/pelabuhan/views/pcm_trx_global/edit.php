...
<div class="col-md-6 col-md-offset-3">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('pelabuhan/pcm_trx_global/action_edit', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            <label>Total Line Meter<span class="wajib">*</span></label>
                            <input type="text" name="lineMeter" class="form-control " id="lineMeter"  placeholder="LIne Meter" required  value="<?php echo $detail->total_lm ?>">
                        </div>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <?php echo form_dropdown("action",$action,"", "class='form-control select2' id='actions' required ") ?>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        validateForm('#ff',function(url,data){
            postData('pcm_trx_global/action_edit',data);
        });
