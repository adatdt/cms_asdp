...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('master_data2/pembatasanTransaksi/action_edit', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">

                        <input type="hidden" name="service_id"  id="service_id" value="<?= $detail->service_id?>" >  
                        <input type="hidden" name="vehicle"  id="vehicle" value="<?= $detail->vehicle_class_id?>" >
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" name="startDate" id="dateFrom" class="form-control " required placeholder="YYYY-MM-DD HH:MM" readonly value="<?= $detail->start_date ?>" style="background-color: #ffffff;" >                       
                        </div>

                        <div class="col-sm-4 form-group">
                            <label>Tanggal Akhir<span class="wajib">*</span></label> 
                            <input type="text" name="endDate" id="dateTo" class="form-control " required placeholder="YYYY-MM-DD HH:MM" readonly  value="<?= $detail->end_date ?>" style="background-color: #ffffff;" >                       
                        </div>
