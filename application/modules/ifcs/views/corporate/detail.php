                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            <ul class="nav nav-tabs " role="tablist">
                                ...
                                <li class="nav-item ">
                                        <a class="label label-primary " data-toggle="tab" href="#tab3">Detail Reward</a>
                                </li>                                
                                <li class="nav-item">
                            ...
                            <div class="tab-content " >
                                ...
                                <div class="tab-pane" id="tab3" role="tabpanel">
                                    <table class="table table-bordered table-striped   table-hover" id="t_reward">
                                        <thead>
...
<script type="text/javascript">
    ...
    var table3= {
        loadData: function() {
            $('#t_reward').DataTable({
                ...
                "columns": [
                    ...
                    {"data": "corporate_code", "orderable": true, "className": "text-left"},
                    {"data": "corporate_name", "orderable": true, "className": "text-left"},
                    {"data": "contract_number", "orderable": true, "className": "text-left"},
                    ...
                    {"data": "total_reward", "orderable": true, "className": "text-right"},
                    {"data": "total_transaction", "orderable": true, "className": "text-right"},
                    {"data": "adjustment_transaction", "orderable": true, "className": "text-right"},
                ...
                "order": [[ 0, "desc" ]],
                "initComplete": function () {
                    var $searchInput = $('div #t_reward_filter input');
                    var data_tables = $('#t_reward').DataTable();
                    $searchInput.unbind();
                    $searchInput.bind('keyup', function (e) {
                        if (e.keyCode == 13 || e.whiche == 13) {
                            data_tables.search(this.value).draw();
        ...
        reload: function() {
            $('#t_reward').DataTable().ajax.reload();
        },
