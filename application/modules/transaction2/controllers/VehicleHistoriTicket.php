...
class VehicleHistoriTicket extends MY_Controller{
	public function __construct(){
		parent::__construct();

        logged_in();
        $this->load->model('vehicleHistoriTicketModel','vehicle');
	...
	public function index(){   
        ...
        $data = array(
            ...
            'title'    => 'Histori Tiket KND',
            'content'  => 'vehicleHistoriTicket/index',
    ...
    public function download_pdf()
    {
        ...
        // echo "hai";
        $this->load->view('vehicleHistoriTicket/pdf',$data);
