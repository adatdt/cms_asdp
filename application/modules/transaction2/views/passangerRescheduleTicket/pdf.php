...
<page backtop="14mm" backbottom="14mm" backleft="-5mm" backright="10mm">
    ...
    <page_header>
        ...
        <p style=" text-align: center; ">
            ...
            <h4>
                Tiket Reschedule Penumpang <?php echo format_date($departDateFrom) . " s/d " . format_date($departDateTo) ?>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo  wordwrap($value->desc_status_reschedule, 18, '<br />', true)  ?></td>
                    <td><?php echo  $value->new_booking_code ?></td>
                    <td><?php echo  $value->reschedule_invoice ?></td>
                    <td><?php echo  $value->reschedule_channel ?></td>
                    ...
                    <td style="text-align: right;"><?php echo  idr_currency($value->reschedule_fee) ?></td>
                </tr>
