	...
	class MyData{
	    ...
	    loadData=()=> {
	        $('#dataTables').DataTable({
	            "ajax": {
	                "url": "<?php echo site_url('transaction/boarding_vehicle') ?>",
	                "type": "POST",
	                "data": function(d) {
	            ...
	            "columns": [
	                    ...
	                    {"data": "first_passanger", "orderable": false, "className": "text-left"},
	                    ...
	                    {"data": "total_passanger", "orderable": false, "className": "text-left"},
