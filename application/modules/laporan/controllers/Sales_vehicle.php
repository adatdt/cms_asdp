 ...
 */
class Sales_vehicle extends MY_Controller {

  public function __construct(){
    parent::__construct();
    // $this->load->model('sales_passengers_model');
    $this->_module   = 'laporan/sales_vehicle';
  ...
  public function index(){
    ...
    $data = array(
      ...
      'title' => 'Penjualan dan Posisi Tiket Loket Penumpang kendaraan',
      'content' => 'sales_vehicle/index',
