...
class Vehicle_class_model extends MY_Model{
	...
	public function vehicleClassList(){
		...
		foreach ($rows_data as $row) {
			...
			switch ($row->id_number_required) {
			case 't':
				$row->id_number_required='<span class="label label-success"><i class="fa fa-check-circle"></i></span>';
				break;
			
			default:
			$row->id_number_required='<span class="label label-danger"><i class="fa fa-check-circle"></i></span>';
				break;
			}
