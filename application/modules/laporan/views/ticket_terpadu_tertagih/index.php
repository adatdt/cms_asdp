		...
		<div class="portlet box blue-hoki">
			...
			<div class="portlet-body">
				...
				<div id="master_tabel" style="display: none">
					...
					<?= generate_button('laporan/ticket_terpadu_tertagih', 'download_pdf', '<button id="printerkita" class="btn btn-sm btn-default"><i class="fa fa-file-pdf-o" style="color: #ea5460"></i> PDF</button>') ?>
					<?= generate_button('laporan/ticket_terpadu_tertagih', 'download_excel', '<button id="excelkita" class="btn btn-sm btn-default"><i class="fa fa-file-excel-o" style="color: #ea5460"></i> EXCEL</button>') ?>
