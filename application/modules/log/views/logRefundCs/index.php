                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 form-inline">
                                            ...
                                            <div class="input-group select2-bootstrap-prepend pad-top">
                                                ...
                                                <?= form_dropdown("lintasan",$lintasan,""," class='form-control  input-small select2' id='lintasan' ") ?>
                                            </div>

                                            <div class="input-group select2-bootstrap-prepend pad-top">
                                                <div class="input-group-addon">Service</div>
                                                <?= form_dropdown("service",$service,""," class='form-control  input-small select2' id='service' ") ?>
                                            </div>                                            
