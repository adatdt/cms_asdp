...
<!--                                                 <div class="input-group-addon "><i class="icon-calendar"></i></div> -->
                                            ...
                                            <?php if (empty($get_port->port_id)) {?>
                                            <div class="input-group select2-bootstrap-prepend" <?php empty($get_port->port_id)? "style='display:none' ":""?> >
...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('transaction/gs') ?>",
                "type": "POST",
                "data": function(d) {
