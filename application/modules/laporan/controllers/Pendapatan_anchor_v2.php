...
error_reporting(0);
class pendapatan_anchor_v2 extends MY_Controller {

	public function __construct(){
		parent::__construct();
		$this->load->model('pendapatan_anchor_model_v2', 'model');
	...
	public function index(){
		...
		$data = array(
            ...
            'url'      => site_url('laporan/pendapatan_anchor_v2/get_list_data'),
            'urlDownload' => site_url('laporan/pendapatan_anchor_v2/download_pdf'),
            'urlDownload_excel' => site_url('laporan/pendapatan_anchor_v2/download_excel'),
    ...
    function get_list_data(){
        ...
        $this->log_activitytxt->createLog($this->_session->name, uri_string(), 'report anchor v2', json_encode($post), $response);
    ...
    function download_excel(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            $filename = strtoupper('Laporan_engker_'. $det->ship_name . "_" . $data['tanggal']).'.xlsx';
