...
<page_header>
    ...
    <p style=" text-align: center; ">
        ...
        <h4>
        <?= 'Detail Dashboard Checkin Kendaraan VS Reservasi Kendaraan Tanggal ' . $date ?>
        </h4></p>
 ...
 <table class="my-table font-small" border="1" >
    ...
    <?php $no=1; foreach ($data as $key=>$value) { ?>
            ...
            <tr>
                ...
                <td><?= wordwrap($value->passanger_type_name,10,"<br>\n"); ?></td>
                <td><?= wordwrap($value->tipe_pembayaran,10,"<br>\n"); ?></td>
                <td><?= wordwrap($value->channel,10,"<br>\n"); ?></td>
                <td><?= wordwrap($value->tarif_ticket,10,"<br>\n"); ?></td>
                <td ><?= wordwrap($value->biaya_admin,10,"<br>\n"); ?></td>
                <td ><?= wordwrap($value->total_bayar,10,"<br>\n"); ?></td>
