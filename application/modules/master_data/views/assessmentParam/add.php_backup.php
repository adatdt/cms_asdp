...
$(document).on('focusin', function(e) {e.stopImmediatePropagation();});
        ...
        validateForm('#ff', function(url, data) {
            data['info'] = CKEDITOR.instances.wysihtml5.getData();
            data['instructionText'] = CKEDITOR.instances.instructionText.getData();
            data['question[0]'] = CKEDITOR.instances['question0'].getData();

            for (var i = 1; i < indexCount; i++) {

                data['question[' + i + ']'] = CKEDITOR.instances[`question${i}`].getData()
