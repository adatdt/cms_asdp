...
class MyData {
    ...
    get loadData(){
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('transaction2/vehicleTicketExpired') ?>",
                "type": "POST",
                "data": function(d) {
                    ...
                    d.statusExpired = document.getElementById('statusExpired').value;
            ...
            "columns": [
                    ...
                    {"data": "description_expired", "orderable": true, "className": "text-left"},
