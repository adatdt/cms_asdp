...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#download_excel").click(function(event){
            ...
            var statusExpired=$("#statusExpired").val();
            var search=$("div #dataTables_filter input").val();

            window.location.href="<?php echo site_url('transaction2/passangerTicketExpired/download_excel?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port="+port+"&route="+route+"&shipClass="+shipClass+"&search="+search+"&statusExpired="+statusExpired;
        });
        ...
        $("#download_pdf").click(function(event){
            ...
            window.open("<?php echo site_url('transaction2/passangerTicketExpired/download_pdf?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port="+port+"&route="+route+"&shipClass="+shipClass+"&search="+search+"&statusExpired="+statusExpired);
        });        
