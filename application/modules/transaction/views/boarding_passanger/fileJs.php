	...
	class MyData
	{
	    ...
	    loadData=()=> 
	    {
	        ...
	        $('#dataTables').DataTable({
	            "ajax": {
	                "url": "<?php echo site_url('transaction/boarding_passanger') ?>",
	                "type": "POST",
	                "data": function(d) {
	            ...
	            "columns": [
	                    ...
	                    {"data": "boarding_date", "orderable": false, "className": "text-left"},
	                    {"data": "boarding_code", "orderable": false, "className": "text-left"},
	                    {"data": "port_name", "orderable": false, "className": "text-left"},
	                    {"data": "dock_name", "orderable": false, "className": "text-left"},
	                    ...
	                    {"data": "age", "orderable": false, "className": "text-left"},
	                    {"data": "gender", "orderable": false, "className": "text-left"},
	                    {"data": "passanger_type_name", "orderable": false, "className": "text-left"},
	                    {"data": "service_name", "orderable":false, "className": "text-left"},
	                    {"data": "ship_name", "orderable": false, "className": "text-left"},
	                    {"data": "ship_class_name", "orderable": false, "className": "text-left"},
	                    {"data": "terminal_name", "orderable": false, "className": "text-left"},
	                    {"data": "manifest_data_from", "orderable": false, "className": "text-left"},
