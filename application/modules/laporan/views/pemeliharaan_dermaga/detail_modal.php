                    ...
                    <div class="portlet-body">
                       ...
                       <table class="table table-333 table-bordered full-width" align="center">
                           <tr>
                               ...
                               <th class="text-center">TARIF <br/>(Dmg)</th>
                           ...
                           foreach ($penumpang as $key_pnp => $pnp) {
                            ...
                            $pendapatan_penumpang += $pnp->dock_fee;
                            ?>
                            <tr>
                                <td></td>
                                <td><?= $pnp->golongan?></td>
                                ...
                                <td class="text-right"><?= idr_currency($pnp->dock_fee) ?></td>
                           ...
                           foreach ($kendaraan as $key_vhc => $vhc) { 
                            ...
                            $pendapatan_kendaraan += $vhc->dock_fee;
                            ?>
                            <tr>
                                <td></td>
                                <td><?= $vhc->golongan?></td>
                                ...
                                <td class="text-right"><?= idr_currency($vhc->dock_fee) ?></td>
                                <td class="text-right"></td>
                            </tr>
                           <?php } ?>
                           <tr>
