...
<page backtop="0mm" backbottom="14mm" backleft="10mm" backright="14mm">
  <page_header>
...
<style type="text/css">
  ...
  <!-- Setting CSS Tabel data yang akan ditampilkan -->
    <table class="tabel full-width font " style="width: 100%" >
        <tr>
            <td colspan="910" style="text-align: center; width:100%">DAFTAR PENUMPANG PADA KENDARAAN</td>
        </tr>
    ...
    <table class="full-width font" style="width: 100%">
        ...
        <tr>
            <td></td>
            <td style="width: 20%; text-align: center; "><?php echo  wordwrap( strtoupper($detail->approved_ship_name), 20, '<br />', true); ?></td>
        </tr>
        <tr>
            <td></td>
    ...
    <table class="tabel full-width font" style="width: 100%">
        <tr>
            <td colspan="7" style="text-align: center; width:100%">DAFTAR PENUMPANG PEJALAN KAKI</td>
        </tr>

        <tr>
            <td colspan="7">Tanggal : <?php echo format_date($detail->schedule_date) ?></td>
        </tr>
        <tr>
            <td colspan="7">Nama Kapal : <?php echo $detail->ship_name ?></td>
        </tr>
...
<!--         <tr>
    ...
    <table class="tabel full-width font" style="width: 100%;">
        ...
        <tr>
            ...
            <th  span="" class="left" style="border-left:none; width:25%">: <?php echo empty($detail->jam_tiba)?"":date("H:i:s",strtotime ($detail->jam_tiba)); ?></th>
        </tr>
        <tr>
            ...
            <th  span="" class="left" style="border-left:none;width:25%">: <?php echo empty($detail->jam_berangkat)?"":date("H:i:s",strtotime ($detail->jam_berangkat));?></th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th style="border-left: none;" >: <?php echo $dewasa_l->total_penumpang+$dewasa_p->total_penumpang+$anak->total_penumpang+$bayi->total_penumpang+$tot ?></th>
            <th class="left" style="border-right: : none;">Jumlah penumpang <br>kendaraan</th>
            <th style="border-left: none; ">: <?php echo array_sum($pnp_knd) ?></th>

        </tr>

        <tr>
            <th class="left" colspan="2" style="text-align: center; border-bottom: none;"></th>
            <th class="left" colspan="2" style="text-align: center; border-bottom: none;">Petugas Kapal</th>
        </tr>
        <tr>
            <th class="left" colspan="2" style="text-align: center;border-bottom: none; "></th>
            <th class="left" colspan="2" style="text-align: center;border-bottom: none; "><?php echo  wordwrap( strtoupper($detail->approved_ship_name), 20, '<br />', true);?></th>
        </tr>
        <tr>
            <th class="left" colspan="2" style="text-align: center;border-bottom: none; "></th>
