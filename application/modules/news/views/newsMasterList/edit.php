...
<div class="col-md-6 col-md-offset-3">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('news/newsMasterList/action_edit', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                 ...
                 <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Judul Berita" required autocomplete="off" maxlength="255" value= "<?= $detail->title ?>" >
                        </div>
                        <div class="col-sm-12 form-group"></div>
                        <div class="col-sm-12 form-group">
                            <label>Sub Judul <span class="wajib">*</span></label>
                            <textarea name="contentData" id="contentData" class="form-control" placeholder="Konten" required autocomplete="off"><?= $detail->sub_title ?></textarea>
                        </div>        
                        <div class="col-sm-12 form-group">
