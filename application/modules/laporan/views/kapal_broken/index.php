                        ...
                        <div class="col-md-12">
                            ...
                            <div id="box" class="boxer hidden">
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th rowspan="4" class="col-img">
                                                <center><img src="<?php echo base_url(); ?>assets/img/asdp.png" style="width:120px; height: auto"></center>
                                            </th>
                                            <th rowspan="4" class="col-title">LAPORAN KAPAL BROKEN</th>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-title">TANGGAL BROKEN</th>
