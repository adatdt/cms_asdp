                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="type" class="form-control" placeholder="Tipe" required value="<?= $detail->type ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        myData.getDetail("<?= site_url() ?>master_data/assessmentParam/getDetail", "<?= $id ?>")
