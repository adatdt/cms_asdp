...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <?php echo form_open('schedule/action_edit', 'id="ff" autocomplete="on"'); ?>
            <div class="row">
                <div class="col-lg-8">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="success">
                                ...
                                <td class="td-schedule"><input type="hidden" name="id" value="<?php echo $id ?>"><?php echo form_dropdown('origin', $origin, $schedule->origin_port_id, 'class="form-control input-sm"data-placeholder="Pilih Pelabuhan Asal" id="origin_port" style="width: 100%" required'); ?></td>
                            </tr>
                            <tr class="success">
                                <td>Pelabuhan Tujuan</td>
                                <td class="td-schedule"><?php echo form_dropdown('destination', $destination, $schedule->destination_port_id, 'class="form-control input-sm" data-placeholder="Pilih Pelabuhan Tujuan" id="destination_port" style="width: 100%" required'); ?></td>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php foreach($vehicle_fare as $row) { ?>
                            <tr class="success">
                                <td><?php echo $row->vehicle_name ?></td>
                                <td align="right"><input type="text" class="form-control input-sm text-right rp" name="vehicle[<?php echo $row->vehicle_id; ?>]" placeholder="<?php echo $row->vehicle_name ?>" required value="<?php echo idr_currency($row->fare); ?>" required></td>
                            </tr>
                            <?php  } ?>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php foreach($passenger as $row) { 
                              ...
                              if($name == 'dewasa'){
                                $value = idr_currency($schedule->adult_fare);
                              }elseif($name == 'anak'){
                                $value = idr_currency($schedule->child_fare);
                              }elseif($name == 'bayi'){
                                $value = idr_currency($schedule->infant_fare);
                              }
                            ?>
                            <tr class="success">
                                <td><?php echo $row->name ?></td>
                                <td align="right"><input type="text" class="form-control input-sm text-right rp" name="<?php echo strtolower($row->name) ?>" placeholder="<?php echo $row->name ?>" required value="<?php echo $value; ?>" required></td>
                            </tr>
                            <?php  } ?>
                        </tbody>
                    </table>
                ...
                <div class="col-lg-4">
                    <table class="table table-striped">
                        ...
                        <?php for ($i=0; $i<=23; $i++){ 
                            ...
                            foreach ($get_time as $key => $value) {
                              if($value->status == 1){
                                if($val == $value->departure){
                                  $checklist = 'checked';
                                }
                              }
                            }
                        ?>
                            ...
                            <tr class="success">
                                <td align="center">
                                    <label class="mt-checkbox mt-checkbox-outline"> &ensp;
                                        <input type="checkbox" <?php echo $checklist ?> value="<?php echo $val ?>" name="hours[]">
                                        <span class="span-border"></span>
                                    </label>
                                </td>
                                <td align="center">
