...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('transaction/stc/action_sail', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-2 form-group">
                            ...
                            <button  class="btn btn-default form-control" disabled style="background-color: #11c211;"><font color="white">sandar</font></button>
                        </div>

                        <div class="col-sm-2 form-group">
                            <label>Jam : <?php echo $open_boarding_date; ?></label>
                            <button  class="btn btn-default form-control" disabled style="background-color: #11c211;"><font color="white">Mulai Pelayanan</font></button>
                        </div>

                        <div class="col-sm-2 form-group">
                            <label>Jam : <?php echo $close_boarding_date; ?></label>
                            <button  class="btn btn-default form-control" disabled style="background-color: #11c211;"><font color="white">Selesai Pelayanan</font></button>
                        </div>

                        <div class="col-sm-2 form-group">
                                <label>Jam : <?php echo $close_ramp_door_date; ?></label>
                                <button class="btn btn-default form-control" disabled style="background-color: #11c211;"><font color="white">Tutup Ramdor</font></button>
                        </div>

                        <div class="col-sm-2 form-group">
                                <label>Jam : <?php echo $sail_date; ?></label>
                                <button  class="btn btn-primary form-control" >Berlayar</button>
                        </div>
