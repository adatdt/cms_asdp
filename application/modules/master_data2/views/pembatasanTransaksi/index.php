...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#download_excel").click(function(event) {
            ...
            window.location.href = "<?php echo site_url('master_data2/pembatasanTransaksi/download_excel?') ?>dateFrom=" + dateFrom + "&dateTo=" + dateTo ;
        });
        ...
        $("#download_pdf").click(function(event) {
            ...
            window.location.href = "<?php echo site_url('master_data2/pembatasanTransaksi/download_pdf?') ?>dateFrom=" + dateFrom + "&dateTo=" + dateTo ;
        });        
