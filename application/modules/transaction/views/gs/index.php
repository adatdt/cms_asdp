...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#download_excel").click(function(event){
            ...
            window.location.href="<?php echo site_url('transaction/gs/download_excel?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port_origin="+port_origin+"&port_destination="+port_destination+"&searchData="+searchData+"&searchName="+searchName;
        });
