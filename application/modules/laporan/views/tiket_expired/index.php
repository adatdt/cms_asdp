							...
							<table class="tabel full-width" align="center">
								<tr>
									...
									<td rowspan="4" class="center bold" style="width: 60%;font-size: 14pt; line-height: 1.5">
										LAPORAN REKAPITULASI EXPIRED</span>
									</td>
	...
	<script type="text/javascript">
		jQuery(document).ready(function() {
			...
			$("#printerkita").on("click", function(e) {
				...
				if (port != null) {
					window.location = "<?php echo site_url('laporan/tiket_expired/get_pdf?port=') ?>" + port +
						"&datefrom=" + datefrom +
						"&dateto=" + dateto +
						"&shift=" + shift +
			...
			$("#excelkita").on("click", function(e) {
				...
				if (port != null) {
					window.location = "<?php echo site_url('laporan/tiket_expired/get_excel?port=') ?>" + port +
						"&datefrom=" + datefrom +
						"&dateto=" + dateto +
						"&shift=" + shift +
						"&ship_class=" + ship_class +
			...
			$("#cari").on("click", function(e) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('laporan/tiket_expired') ?>",
					dataType: 'json',
					data: {
						port: $("#port").val(),
						datefrom: $("#datefrom").val(),
