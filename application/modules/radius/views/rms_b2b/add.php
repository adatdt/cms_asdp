...
<div class="col-md-10 col-md-offset-1">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('radius/rms_b2b/action_add', 'id="ff" autocomplete="off"'); ?>
            <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            <select name="radiusType" class="form-control select2" required id="radiusType">
                                ...
                                <option value="<?= $this->enc->encode(1)?>" data-id="km" >KM (Kilometer)</option>
                                <option value="<?= $this->enc->encode(2)?>" data-id="m" >M (Meter)</option>
                            </select>
                        ...
                        <div class=" col-sm-3 form-group">
                            ...
                            <input type="text" name="latitude" class="form-control"  id="lat"  placeholder="Latitude" required>            
                        </div>
                        <div class="col-sm-2 form-group">
                            <label>Longitude <span class="wajib">*</span></label>
                            <input type="text" name="longitude" class="form-control" id="long"  placeholder="Longitude" required>
                        </div>  
                            ...
                            <div style="background-color:#e1f0ff; padding:10px;">
                                <div class="portlet box blue-madison">
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption">Merchant </div>
    ...
    $(document).ready(function(){
        ...
        tableMerchant.on( 'draw.dt', function () {
            ...
            $(`.hps`).on("click", function(){
                ...
                // insert ke input merchant
                let merchantData = $(`#merchant`).val();
                let splitMerchant = merchantData.split(",")
                let setMerchantValue = splitMerchant.filter(function(x){
                    return x != id
                })
                $(`#merchant`).val(setMerchantValue.toString());
        ...
        const tableOutlet = $('#tableOutlet').DataTable({
            "language": {
                "aria": {
                    "sortAscending": ": activate to sort column ascending",
                    "sortDescending": ": activate to sort column descending"
            ...
            "order": [[ 0, "desc" ]], 
            "initComplete": function () {
                var $searchInput = $('div #tableOutlet_filter input');
                var data_tables = $('#tableOutlet').DataTable();
                $searchInput.unbind();
                $searchInput.bind('keyup', function (e) {
                    if (e.keyCode == 13 || e.whiche == 13) {
                        data_tables.search(this.value).draw();
