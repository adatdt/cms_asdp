		...
		<tr>
			...
			<th class="center bold" style="width: 15%">TARIF
				...
				<th class="center bold" style="width: 15%">PRODUKSI
					...
					<tr>
						<th colspan="6">Fee Administrasi Asuransi Jasa Raharja Putra <?=$persen_jrp ?> % = <b>Rp. <?php $hasil_akhir = $pendapatan_penumpang+$pendapatan_kendaraan; echo idr_currency($persen_jrp * $hasil_akhir / 100) ?></b></th>
					</tr>
				</table>
				<br>
			...
			$filename = strtoupper("Asuransi_jrp_" . $pelabuhan . "_" . $this->input->get('datefrom') . "_" . $this->input->get('dateto'));
			try
			{
