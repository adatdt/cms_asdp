...
class MyData
	{
        loadData=()=> {
            $('#dataTables').DataTable({
                "ajax": {
                    "url": "<?php echo site_url('transaction/boarding_ticket_manual') ?>",
                    "type": "POST",
                    "data": function(d) {
                        ...
                        d.statusBoarding = document.getElementById('statusBoarding').value;
                ...
                "columns": [
                        ...
                        {"data": "status_boarding", "orderable": true, "className": "text-center"},
                ],
                "language": {
                    "aria": {
        ...
        loadData2 = () =>{
            $('#dataTables2').DataTable({
                "ajax": {
                    "url": "<?php echo site_url('transaction/boarding_ticket_manual/get_data_vehicle') ?>",
                    "type": "POST",
                    "data": function(d) {
                        ...
                        d.statusBoarding = document.getElementById('statusBoarding2').value;
