...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('news/newsInfo/action_add', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Judul Berita Info" required autocomplete="off" maxlength="255">
                        </div>
                        <div class="col-sm-4 form-group">
