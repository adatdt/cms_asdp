...
class M_port_branch extends MY_Model{
    ...
    public function dataList(){
		...
		// mengambil filter port berdasarkan port berdasarkan port user
		...
		{
			$where .="and ( a.branch_name ilike '%".$iLike."%'
		...
		$sql 		   = "
						select c.name as ship_class_name, b.name as port_name , a.* from app.t_mtr_branch a
