...
<page backtop="25mm" backbottom="0mm" backleft="0mm" backright="0mm">
    <page_header>
    ...
    <table class="tabel full-width" align="center">
        <tr>
            ...
            <th class="center bold" style="width: 25%">NAMA<br>PERUSAHAAN</th>
            <th class="center bold" style="width: 20%">NAMA<br>KAPAL</th>
            <th class="center bold" style="width: 7%">JLH <br>TRIP</th>
            <th class="center bold" style="width: 10%">Penumpang</th>
            <th class="center bold" style="width: 10%">Kendaraan</th>
            <th class="center bold" style="width: 10%">JUMLAH</th>
        </tr>
        <tr>
        ...
        ?>
            <tr>
                ...
                <td class="left">
                    <?php echo wordwrap( $value->company, 40, '<br />', true)?>
                    <!-- <?= $value->company ?> -->
                </td>
                <td class="left">
                    <?= $value->ship_name ?>
        ...
        <?php } ?>
        <tr>
            <td colspan="3" class="center bold" style="padding: 2px 8px">
                JUMLAH
            </td>
    ...
    <page_footer>
        <i> dicetak pada : <?=$tanggal_cetak ?> </i>
    </page_footer>
...
$filename = strtoupper('rekapitulasi_rekap_kapal'.$date);
try
{
  // setting paper
