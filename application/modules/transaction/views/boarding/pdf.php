...
<!--         <tr>
    ...
    <table class="tabel full-width font" style="width: 100%;">
        ...
        <tr>
            ...
            <th  span="" class="left" style="border-left:none; width:25%">: 
            <?php echo empty($detail->jam_tiba)?"":date("H:i:s",strtotime ($detail->jam_tiba)); ?></th>
        </tr>
        <tr>
            ...
            <th  span="" class="left" style="border-left:none;width:25%">: 
            <?php echo empty($detail->jam_berangkat)?"":date("H:i:s",strtotime ($detail->jam_berangkat));?></th>
        </tr>
        <tr>
            ...
            <th class="left" colspan="2" valign="top">
               <table >
                   <tr>
                       <td colspan="3" style="border: none;">Kendaraan</td>

                   </tr>
                    <?php $total=array(); $pnp_knd=array(); foreach ($a as $a) { ?>
                    <tr>
                       <td style="border: none; padding-left: 20px"><?php echo strtoupper($a->tipe_name);  ?></td>
                       <td style="border: none;">: <?php echo $a->total_kendaraan;  $total[]=$a->total_kendaraan; ?>,
                       </td>
                       <td style="border: none;">
                        TOTAL PNP: <?php echo empty($a->total_penumpang)?"0":$a->total_penumpang; 
                        $pnp_knd[]=$a->total_penumpang
                        ?>
                       </td>
                   </tr>
                    <?php  } ?>
        ...
        <tr>
            <th class="left" style="border-right: : none;">Jumlah Penumpang<br> dan Penumpang <br>Kendaraan</th><th style="border-left: none;">: <?php echo $dewasa_l->total_penumpang+$dewasa_p->total_penumpang+$anak->total_penumpang+$bayi->total_penumpang+$tot ?></th>
            <th class="left" style="border-right: none;">Jumlah Penumpang <br>Kendaraan</th><th style="border-left: none;">: <?php echo array_sum($pnp_knd); ?></th>
        </tr>
        <tr>
