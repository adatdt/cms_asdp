                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            <div class="input-group">
                                <div class="icheck">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                        <input type="checkbox" class="allow" name='status_web_cs' data-checkbox="icheckbox_flat-grey"  value="yes" <?php echo $detail->status_web_cs==1?"checked":""; ?> > Status Web CS
                                    </label>                                    
                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            <div class="input-group">
                                <div class="icheck">
                                    ...
                                    <label>
                                        <input type="checkbox" class="allow" name='status_ifcs' data-checkbox="icheckbox_flat-grey"  value="yes" <?php echo $detail->status_ifcs==1?"checked":""; ?> > Status IFCS
                                    </label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
                                    <label>
                                        <input type="checkbox" class="allow" name='status_b2b' data-checkbox="icheckbox_flat-grey"  value="yes" <?php echo $detail->status_b2b==1?"checked":""; ?> > Status B2B
                                    </label>                                    
