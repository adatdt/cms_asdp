                                ...
                                <table class="table table-bordered table-hover table-striped" id="dataTables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>DERMAGA</th>
                                            <th>TUJUAN</th>
                                            <th>NAMA KAPAL <br>(RENCANA)</th>
                                            <th>NAMA KAPAL <br>(REALISASI)</th>
                                            <th>MASUK ALUR <br>(REALISASI)</th>
                                            <th>JAM SANDAR <br>(RENCANA)</th>
                                            <th>JAM SANDAR <br>(REALISASI)</th>
                                            <th>JAM BUKA <br>LAYANAN <br>(RENCANA)</th>
                                            <th>JAM BUKA <br>LAYANAN <br>(REALISASI)</th>
                                            <th>JAM TUTUP <br>LAYANAN <br>(RENCANA)</th>
                                            <th>JAM TUTUP <br>LAYANAN <br>(REALISASI)</th>
                                            <th>JAM TUTUP <br>RAMDOR <br>(RENCANA)</th>
                                            <th>JAM TUTUP <br>RAMDOR <br>(REALISASI)</th>
                                            <th>JAM <br>BERANGKAT <br>(RENCANA)</th>
                                            <th>JAM <br>BERANGKAT <br>(REALISASI)</th>
                                            <th>TRIP </th>
                                            <th>CALL </th>
...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('transaction/trx_mtr_schedule') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "trx_schedule_code", "orderable": true, "className": "text-left"},
                    ...
                    {"data": "pl_ship_name", "orderable": true, "className": "text-left"},
                    {"data": "rl_ship_name", "orderable": true, "className": "text-left"},
                    {"data": "ploting_date", "orderable": true, "className": "text-left"},
                    {"data": "docking_on", "orderable": true, "className": "text-left"},
                    {"data": "rl_docking", "orderable": true, "className": "text-left"},
                    {"data": "open_boarding_on", "orderable": true, "className": "text-left"},
                    {"data": "rl_open_boarding", "orderable": true, "className": "text-left"},
                    {"data": "close_boarding_on", "orderable": true, "className": "text-left"},
                    {"data": "rl_close_boarding", "orderable": true, "className": "text-left"},
                    {"data": "close_rampdoor_on", "orderable": true, "className": "text-left"},
                    {"data": "rl_close_ramp_door", "orderable": true, "className": "text-left"},
                    {"data": "sail_time", "orderable": true, "className": "text-left"},
                    {"data": "rl_sail", "orderable": true, "className": "text-left"},
                    {"data": "trip", "orderable": true, "className": "text-left"},
                    {"data": "call", "orderable": true, "className": "text-left"},
            ],
            "language": {
                "aria": {
    ...
    $(document).ready(function () {
        ...
        $("#btndownload").click(function(event){
            ...
            window.location.href="<?php echo site_url('transaction/trx_mtr_schedule/download_excel?') ?>sortFrom="+sortFrom+"&sortTo="+sortTo+"&port="+port+"&dock="+dock+"&search="+search;
        });
