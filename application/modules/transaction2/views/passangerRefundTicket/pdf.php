...
<page backtop="14mm" backbottom="14mm" backleft="-3mm" backright="10mm">
    ...
    <page_header>
        ...
        <p style=" text-align: center; ">
            ...
            <h4>
                Refund Tiket Penumpang Keberangakatan tanggal <?php echo format_date($departDateFrom) . " s/d " . format_date($departDateTo) ?>
    ...
    <table class="my-table font-small" border="1">
        <thead>
            <tr class="headerTable">
                ...
                <th>STATUS <br />TIKET <br />REFUND</th>
                <th>WAKTU <br />APPROVAL</th>
                <th>TOTAL <br />BIAYA <br />ADMINISTRASI</th>
                <th>BIAYA <br />ADMINISTRASI <br />REFUND </th>
                <th>BIAYA <br /> REFUND </th>
        ...
        <tbody>
            ...
            foreach ($data as $key => $value) {
                ...
                empty($value->depart_date) ? $departDate = "" : $departDate = format_date($value->depart_date);
            ?>
                <tr>
                    ...
                    <td><?php echo  wordwrap($value->status_booking, 18, '<br />', true)  ?></td>
                    <td><?php echo  wordwrap($value->status_refund, 18, '<br />', true)  ?></td>
                    <td><?php echo  wordwrap($value->tanggal_approve, 20, '<br />', true) ?></td>
                    <td style="text-align: right;"><?php echo  idr_currency($value->total_biaya) ?></td>
                    <td style="text-align: right;"><?php echo  idr_currency($value->biaya_admin) ?></td>
                    <td style="text-align: right;"><?php echo  idr_currency($value->biaya_refund) ?></td>
