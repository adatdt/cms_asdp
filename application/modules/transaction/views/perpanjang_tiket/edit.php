                 ...
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" required name="dock_fee" id="dock_fee" placeholder="Nama Deramaga" onkeypress="return isNumberKey(event)" value="<?php echo $detail->fare ?>">
                        </div>

                        <div class="col-sm-6 form-group">
                            <label>Tarif tambat <span class="wajib">*</span></label>
                            <input type="text" class="form-control" required name="tambat_fee" id="tambat_fee" placeholder="Nama Deramaga" onkeypress="return isNumberKey(event)" value="<?php echo $detail->tambat_fare ?>">
                        </div>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <select class="form-control select2" name="ship_class" required >
                                ...
                                <?php foreach($ship_class as $key=>$value ) { ?>
                                    <option value="<?php echo $this->enc->encode($value->id)?>" <?php echo $value->id==$detail->ship_class_id?"selected":"" ?> ><?php echo strtoupper($value->name); ?></option>
                                <?php } ?>                                
                            </select>
                        </div>
