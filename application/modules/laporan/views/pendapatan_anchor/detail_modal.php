                    ...
                    <div class="portlet-body">
                       ...
                       <table class="table table-333 table-bordered full-width" align="center">
                           <tr>
                               ...
                               <th class="text-center">TARIF <br/>(JR)</th>
                           ...
                           <?php foreach ($detail_passenger as $key_pnp => $pnp) { ?>
                            <tr>
                                ...
                                <td class="text-right"><?= idr_currency($pnp->insurance_fee) ?></td>
                           ...
                           <?php foreach ($detail_vehicle as $key_vhc => $vhc) { ?>
                            <tr>
                                ...
                                <td class="text-right"><?= idr_currency($vhc->insurance_fee) ?></td>
                       ...
                       <?php
                        $total = $sub_total_passenger->sub_total_amount+$sub_total_vehicle->total_amount;
                        // $fee = 0;
                        // if($total){
                        //   $fee = (15.4/100) * $total;
                        // }
                       ?>
                       <div>Fee Administrasi Asuransi Jasa Raharja Putra 13,75% = Rp.<?= idr_currency($total) ?></div>
