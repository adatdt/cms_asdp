        ...
        option = {
            ...
            tooltip: {
                ...
                formatter: function(params, c) {
                    ...
                    let listReservasi = "";
                    let classNameDiv = "";
                    // let detailTotalReservasi="";
                    let detail_url= <?php echo $detail_url; ?>;
                    ...
                    {                        
                        if(data.date[idx] === params[0].axisValue){
                            ...
                            let detailTotalReservasi    = `<p></p><div align="center" ><a href="<?= site_url()?>dashboard/detail_reservasi?${paramDetail}&detail=reservasi" target="_blank" style="color:white" >Detail</a></div>`;
                            let detailTotalCheckin      = `<p></p><div align="center" ><a href="<?= site_url()?>dashboard/detail_reservasi?${paramDetail}&detail=checkin" target="_blank" style="color:white" >Detail</a>`;
                            let detailTotalNotCheckin   = `<p></p><div align="center" ><a href="<?= site_url()?>dashboard/detail_reservasi?${paramDetail}&detail=notCheckin" target="_blank" style="color:white" >Detail</a></div> `;
                            let detailTotalBoarding     = `<p></p><div align="center" ><a href="<?= site_url()?>dashboard/detail_reservasi?${paramDetail}&detail=boarding" target="_blank" style="color:white" >Detail</a></div>`;
                            // let detailTotalNotBoarding  = `<p></p><div align="center" ><a href="<?= site_url()?>dashboard/detail_reservasi?${paramDetail}&detail=notBoarding" target="_blank" style="color:white">Detail</a></div>`;
