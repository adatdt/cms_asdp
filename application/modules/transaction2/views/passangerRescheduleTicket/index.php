                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 form-inline">
                                            ...
                                            <div class="input-group select2-bootstrap-prepend pad-top">
                                                ...
                                                <?php echo form_dropdown('statusReschedule', $statusReschedule, '', 'id="statusReschedule" class="form-control select2"'); ?>
                                            </div>
                                ...
                                <table class="table table-bordered table-hover table-striped" id="dataTables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>STATUS TIKET<br /> RESCHEDULE</th>
                                            <th>REFERENSI KODE<br /> BOOKING BARU</th>
                                            <th>NO INVOICE<br /> RESCHEDULE <br />(PAID)</th>
                                            <th>PAYMENT <br /> CHANNEL <br />RESCHEDULE</th>
                                            <th>TOTAL BIAYA <br />ADMINISTRASI</th>
                                            <th>BIAYA<br /> ADMINISTRASI<br /> RESCHEDULE</th>
                                            <th>BIAYA RESCHEDULE</th>
                                        </tr>
                                    </thead>
                                    <tfoot></tfoot>
                                </table>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#download_excel").click(function(event) {
            ...
            var statusReschedule = $("#statusReschedule").val();

            window.location.href = "<?php echo site_url('transaction2/passangerRescheduleTicket/download_excel?') ?>dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&paymentDateFrom=" + paymentDateFrom + "&paymentDateTo=" + paymentDateTo + "&port=" + port + "&route=" + route + "&shipClass=" + shipClass + "&statusReschedule=" + statusReschedule;
        });
        ...
        $("#download_pdf").click(function(event) {
            ...
            window.open("<?php echo site_url('transaction2/passangerRescheduleTicket/download_pdf?') ?>dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&paymentDateFrom=" + paymentDateFrom + "&paymentDateTo=" + paymentDateTo + "&port=" + port + "&route=" + route + "&shipClass=" + shipClass + "&statusReschedule=" + statusReschedule);
        });
