<html>
      ...
      .transform2{
        ...
        function hariku($hariku)
        {
            ...
            if($passenger[0]->channel =='web_admin' ) //nama channel SAB
            {
                // $header ="<b>SAB</b>";
                $header ="<b>SKPT</b>";
            ...
            {
                if(strtoupper($passenger[0]->channel) =='IFCS' )
                {
                    ...
                    <tr>
                        <td colspan="4" >
                            <div style="width:200px; margin-top:-10px;">
                                ...
                                <div style="font-size: 7px; width:100%">NPWP : <?=$eticketNpwp->info;?>
                ...
                <p style="page-break-after: never;">
                    <div width="100%">
                        ...
                        <tr style="background-color: #ffeed1;  ">
                            ...
                            <td style="width:30%; text-align:justify; padding:8px 0px 8px 5px; font-size:13px;" valign="middle">
                                Nomor ID
                            </td>
                        ...
                        <tr style="<?= $bgColor; ?>" >
                            ...
                            <td style=" text-align:justify; padding:5px 0px 5px 5px; font-size:12px;" valign="top">
                                <?= $value->id_number ?>
                            </td>
                            <td style=" text-align:justify; padding:5px 0px 5px 0px; font-size:12px;" valign="top">
                        ...
                        <table style="width:100%;  border-collapse: collapse">
                            ...
                            ?>    
                                ...
                                <tr>
                                    ...
                                    <td style="width:75%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">: <?= $passenger[0]->customer_name ?>
                                    </td>
                                </tr>
                                <tr style="background-color:#f2f2f2; " >
                                    <td style="width:25%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">
                            ...
                            <?php } else { ?>
                                ...
                                <tr style="background-color:#f2f2f2; ">
                                    ...
                                    <td style="width:25%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">: <?= $passenger[0]->customer_name ?>
                                    </td>
                                </tr>
                                <tr >
                                    <td style="width:25%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">
  ...
  <?php
        ...
        $dompdf->add_info('Title', 'Tiket Online '.$booking_code);
        $dompdf->stream('Tiket_Online_'.$booking_code.".pdf", array("Attachment" => false));
