...
<div class="col-md-6 col-md-offset-3">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('ifcs/corporate/action_add_contract', 'id="ff" autocomplete="off"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" name="start_date" class="form-control date"  placeholder="YYYY-MM-DD" required>
                        </div>

                        <div class="col-sm-6 form-group">
                            <label>Akhir Kontrak <span class="wajib">*</span></label>
                            <input type="text" name="end_date" class="form-control date"  placeholder="YYYY-MM-DD" required>
                        </div> 
