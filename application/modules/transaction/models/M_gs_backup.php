...
class M_gs extends MY_Model{
    ...
    public function dataList(){
		...
		$where = " WHERE a.status is not null and a.status<>'-5' and (to_char(a.created_on,'yyyy-mm-dd') between '".$dateFrom."' and '".$dateTo."' ) ";
	...
	{
		return $this->dbView->query("select b.name as ship_name, a.* from app.t_trx_open_boarding a
	...
	public function download(){
		...
		$check=$this->dbView->query("select * from app.t_mtr_user_ship a
		...
		$where = " WHERE a.status is not null and a.status<>'-6' and (date(a.created_on) between '".$dateFrom."' and '".$dateTo."' ) ";
