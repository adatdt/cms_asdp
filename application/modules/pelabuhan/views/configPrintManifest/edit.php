...
<div class="col-md-7 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('pelabuhan/configPrintManifest/action_edit', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                <div class="form-group">
                     <div class="row">
                        <div class="col-sm-6">
                            <label>Pelabuhan <span class="wajib">*</span></label>
                            <?= form_dropdown("port",$port,$portSelected,' class="form-control select2" required id="port" ') ?>
                        </div>
                        <div class="col-sm-6">
                            <label>Layanan <span class="wajib">*</span></label>
                            <?= form_dropdown("shipClass",$shipClass,$shipClassSelected,' class="form-control select2" required id="shipClass" ') ?>
                        ...
                        <div class="col-sm-6 form-group">
                            <p></p>
                             ...
                             <label class="switch" style="">
                                ...
                                <input type="checkbox" name="checkbox_param" id="togBtn" value="1"  <?= $detail->configuration_status == 't'?"checked":""; ?> ><div class="slidertes round"></div>
                            </label>
                         </div>
                    </div>
                </div>
