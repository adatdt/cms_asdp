...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('pelabuhan/passanger_type') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "min_age", "orderable": true, "className": "text-right"},
                    {"data": "max_age", "orderable": true, "className": "text-right"},
                    {"data": "description", "orderable": true, "className": "text-left"},
                    {"data": "ordering", "orderable": true, "className": "text-right"},
