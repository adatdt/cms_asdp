                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-xs-12">
                                    <div class="mt-element-ribbon bg-grey-steel">
                                        <div class="ribbon ribbon-color-primary uppercase">Total Check In Penumpang Kendaraan</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var t = $('#dataTables2').DataTable({
	            "ajax": {
	                "url": "<?php echo site_url('transaction/check_in_vehicle/listDetail') ?>",
	                "type": "POST",
                    "dataType":"json",
                    "data" : function(d){
                        d.id = "<?php echo $id ?>"
	            ...
	            "columns": [
                        ...
                        {"data": "checkin_status", "orderable": true, "className": "text-left"},
