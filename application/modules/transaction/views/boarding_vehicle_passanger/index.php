                                ...
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-sm-12 form-inline">
                                            ...
                                            <!-- tidak ada permintaan filtering golongan sesuai mockup CR cetak boarding pass -->
                                            <!-- <div class="input-group select2-bootstrap-prepend">
                                           ...
                                           <div class="input-group pad-top">
                                                <div class="input-group-btn">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a href="javascript:;" onclick="myData.changeSearch('No. Polisi','idNumber')" >No. Polisi</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!-- /btn-group -->
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#download_excel").click(function(event){
            ...
            window.location.href="<?php echo site_url('transaction/boarding_vehicle_passanger/download_excel?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port="+port+"&searchData="+searchData+"&searchName="+searchName+"&vehicleClass="+vehicleClass;
        });
