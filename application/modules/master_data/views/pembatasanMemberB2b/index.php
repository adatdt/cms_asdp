                        ...
                        <div class="row">
                            <div class="col-sm-12 form-inline">
                                ...
                                <div class="input-group select2-bootstrap-prepend">
                                    ...
                                    <input type="text" class="form-control waktu input-small" style="background-color: #ffffff;" id="dateFrom" placeholder="YYYY-MM-DD HH:II" readonly>
                                    <div class="input-group-addon">s/d</div>
                                    <input type="text" class="form-control waktu input-small" style="background-color: #ffffff;" id="dateTo" placeholder="YYYY-MM-DD HH:II" readonly>
                                </div>
                                ...
                                <div class="input-group pad-top">
                                    <div class="input-group-btn">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="javascript:;" onclick="myData.changeSearch('Nama Merchant','merchantName')">Nama Merchant</a>
                                            </li>                                                                                                                                             
                                        </ul>
                                    </div>
                                    <!-- /btn-group -->
