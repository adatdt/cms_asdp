<?php
error_reporting(0);
class Rekap_muatan_perkapal_new extends MY_Controller {

    public function __construct(){
        parent::__construct();
        $this->load->model('rekap_muatan_perkapal_new_model', 'rekap_muatan');
        $this->load->model('global_model');
        $this->_module   = 'laporan/rekap_muatan_perkapal_new';
    ...
    public function index(){
        ...
        $data = array(
            ...
            'content'       => 'rekap_muatan_perkapal_new/index',
