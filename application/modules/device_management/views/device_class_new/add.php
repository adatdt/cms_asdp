...
<script type="text/javascript">
    ...
    function getPosVehicle() {
        $.ajax({
            ...
            success:function(x) {
                ...
                var html = "<option value=''>Pilih</option>";
                for(var i=0; i<x.length; i++) {
                    html += "<option value='"+x[i].terminal_code+"'>"+x[i].terminal_name+"</option>";
                }
    ...
    function getData() {
            ...
            if(device_type == 1 || device_type == 2 || device_type == 3 || device_type == 4 || device_type == 5 || device_type == 12 || device_type == 19) {
                $("#div_dock").hide();
                $("#div_imei").hide();
                $("#div_ship_class").show();
