...
<div class="col-md-5 col-md-offset-4">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('transaction/boarding_ticket_manual/action_import_excel', 'id="ff" autocomplete="off"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">            
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <?= form_dropdown("service",$service,"",' class="form-control select2"  id="service" required ') ?>
                        </div>                                          
