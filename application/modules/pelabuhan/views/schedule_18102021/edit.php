                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <select class="form-control select2"  name="ship" id="ship">
                                ...
                                <?php foreach($ship as $key=>$value ) { ?>
                                    <option value="<?php echo $this->enc->encode($value->id) ?>" <?php echo $detail->ship_id==$value->id?"selected":"" ?>><?php echo strtoupper($value->name); ?> (<?php echo strtoupper($value->ship_class_name); ?>)</option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-4 form-group">
                            <label>Tanggal Jam Buka Layanan </label>
                                ...
                                value='<?php echo $detail->open_boarding_on ?>'
                                >
                                <!-- <span class="input-group-addon"><i class="icon-calendar"></i></span> -->
                        </div>
                        ...
                        <div class="col-sm-4 form-group">
                            <label>Jam Tutup Layanan </label>
                                <input type="text" name="close_boarding" class="form-control waktu"  placeholder="YYYY-MM-DD HH:MM" autocomplete="off" value='<?php echo $detail->close_boarding_on ?>'
                                >
                                <!-- <span class="input-group-addon"><i class="icon-calendar"></i></span> -->
                        ...
                        <div class="col-sm-4 form-group">
                            <label>Jam Tutup Ramdoor</label>
                                <input type="text" name="close_ramdoor" class="form-control waktu"  placeholder="YYYY-MM-DD HH:MM" autocomplete="off" value='<?php echo $detail->close_rampdoor_on ?>'
                                >
                        ...
                        <div class="col-sm-4 form-group">
                            <label>Tanggal Keberangkatan</label>
                                ...
                                <input type="text" name="sail_time" class="form-control waktu"  placeholder="YYYY-MM-DD HH:MM"autocomplete="off" value=' <?php echo $detail->sail_time ?>'
                                >
