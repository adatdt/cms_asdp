                 ...
                 <div class="form-group">
                    <div class="row">
                        <div class="col-sm-3 form-group">
                            ...
                            <input type="text" class="form-control date" id="start_date" name="start_date" value="<?php echo  date("Y-m-d H:i", strtotime($detail->start_date)); ?>" readonly required placeholder="Masukan tanggal mulai">
                        </div>

                        <div class="col-sm-3 form-group">
                            <label>Tanggal Selesai <span style="color:red">*</span></label>
                            <input type="text" class="form-control date" id="end_date" name="end_date" value="<?php echo date("Y-m-d H:i", strtotime($detail->end_date)); ?>" readonly required placeholder="Masukan tanggal selesai">
                        </div>
                    ...
                    <div class="row">
											...
											<div class="col-sm-2 form-group">
													...
													<div class="input-group">
															<div class="icheck">
																	<label>
																			<input type="checkbox" class="allow" name='b2b'  id="b2b" data-checkbox="icheckbox_flat-grey"  value="yes" <?php echo $detail->b2b == "t" ?"checked":""; ?> > B2B
																	</label>
															</div>
													</div>
											</div>
