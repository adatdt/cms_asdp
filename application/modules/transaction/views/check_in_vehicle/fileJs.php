	...
	class MyData
	{
	    ...
	    loadData=()=>
	    {
	        $('#dataTables').DataTable({
	            "ajax": {
	                "url": "<?php echo site_url('transaction/check_in_vehicle') ?>",
	                "type": "POST",
	                "data": function(d) {
	            ...
	            "columns": [
	                    ...
	                    {"data": "booking_channel", "orderable": false, "className": "text-left"},
	                    {"data": "service_name", "orderable": false, "className": "text-left"},
	                    {"data": "port_origin", "orderable": false, "className": "text-left"},
	                    ...
	                    {"data": "method_checkin", "orderable": false, "className": "text-left"},
