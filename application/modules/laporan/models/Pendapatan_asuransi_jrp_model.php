...
class Pendapatan_asuransi_jrp_model extends MY_Model
{
	...
	public function penumpangku($port_id, $datefrom, $dateto, $ship_class_id, $shift_id,  $ticketType)
	{
		$where_port = "";
		$where_ship_class = "";
		$where_shift = "";
	...
	public function kendaraanku($port_id, $datefrom, $dateto, $ship_class_id, $shift_id, $ticketType)
	{
		$where_port = "";
		$where_ship_class = "";
		$where_shift = "";
