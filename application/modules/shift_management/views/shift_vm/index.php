...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('shift_management/shift_vm') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "shift_login", "orderable": true, "className": "text-left"},
                    {"data": "shift_logout", "orderable": true, "className": "text-left"},
