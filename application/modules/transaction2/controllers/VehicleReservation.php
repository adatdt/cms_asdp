...
class VehicleReservation extends MY_Controller{
	public function __construct(){
		parent::__construct();

        logged_in();
        $this->load->model('vehicleReservationModel','vehicle');
        $this->load->model('global_model');
        $this->load->library('log_activitytxt');

        $this->_table    = 'app.t_trx_booking';
        $this->_username = $this->session->userdata('username');
        $this->_module   = 'transaction2/vehicleReservation';
	...
	public function index(){   
        ...
        $data = array(
            ...
            'title'    => 'Reservasi Kenadaraan Online',
            'content'  => 'vehicleReservation/index',
    ...
    public function download_excel()
    {
        ...
        $file_name = 'Reservasi KND Online Keberangkatan '.$dateFrom.' s/d '.$dateTo;
    ...
    public function download_pdf()
    {
        ...
        // echo "hai";
        $this->load->view('vehicleReservation/pdf',$data);
