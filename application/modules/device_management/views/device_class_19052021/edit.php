                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <select id="detail" class="form-control  select2 " dir="" required name="detail" disabled>
                                ...
                                <option value="<?php echo $value->terminal_type_id; ?>" <?php echo $value->terminal_type_id==$detail->terminal_type?"selected":""; ?> ><?php echo strtoupper($value->terminal_type_name." - ".$value->channel) ?></option>
                                <?php } ?>
                            </select>
