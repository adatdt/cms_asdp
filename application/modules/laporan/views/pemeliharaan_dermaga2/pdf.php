            ...
            <th class="center bold" style="width: 15%">TARIF
                ...
                <th class="center bold" style="width: 15%">PRODUKSI
                    ...
                    <tr>
                     ...
                     <th class="right bold"><?= idr_currency($sub_total_passenger->ticket_count) ?></th>
                     <th class="right bold"><?= idr_currency($sub_total_passenger->sub_total_amount) ?></th>
                     <th></th>
                 </tr>
                 <tr>
                ...
                <tr>
                 <th class="center"></th>
                 <th colspan="2" class="bold">Sub Jumlah</th>
                 <th class="right bold"><?= idr_currency($sub_total_vehicle->ticket_count) ?></th>
                 <th class="right bold"><?= idr_currency($sub_total_vehicle->total_amount) ?></th>
                 <th></th>
             </tr>

             <tr>
                 <th colspan="3" class="center bol">Jumlah</th>
                 <th class="right bold"><?= idr_currency($sub_total_passenger->ticket_count+$sub_total_vehicle->ticket_count) ?></th>
                 <th class="right bold"><?= idr_currency($sub_total_passenger->sub_total_amount+$sub_total_vehicle->total_amount) ?></th>
                 <th></th> 
             </tr>
         </table>
         <br>
