    ...
    class MyData {
        ...
        get loadData() {
            $('#dataTables').DataTable({
                "ajax": {
                    "url": "<?php echo site_url('transaction2/passangerRescheduleTicket') ?>",
                    "type": "POST",
                    "data": function(d) {
                        ...
                        d.statusReschedule  = document.getElementById('statusReschedule').value;
                    },
                },
                ...
                "columns": [{
                    ...
                    {
                        "data": "desc_status_reschedule",
                        "orderable": true,
                        "className": "text-left"
                    },
                    {
                        "data": "new_booking_code",
                        "orderable": true,
                        "className": "text-left"
                    },
                    {
                        "data": "reschedule_invoice",
                        "orderable": true,
                        "className": "text-left"
                    },
                    {
                        "data": "reschedule_channel",
                        "orderable": true,
                        "className": "text-left"
                    },
                    {
        ...
        route(data) {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "json",
                url: "<?php echo site_url() ?>transaction2/passangerRescheduleTicket/getRoute",
                data: "port=" + data.port,
                success: (x) => {
