...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('news/newsCon/action_edit', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <?php                                                     
                                 if(date('Y-m-d H:i', strtotime($detail->start_published)) <= date('Y-m-d H:i') ): 
                                    $typeStartDate = 2;    
                                 ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input type="text" id="videoUrl" name="videoUrl" class="form-control" placeholder="URL Video" value="<?= $detail->video ?>" autocomplete="off">
                            </div>                        
                            <div class="col-sm-12 form-group" id="viewImage">
                            <label>Gambar</label>
                                <img src="<?= $detail->image->thumbnail ?>" width="100%"/>
                            </div>
                        </div>   
