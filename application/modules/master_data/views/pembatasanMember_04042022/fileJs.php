    ...
    class MyData{
        ...
        loadData() 
        {
            var table= $('#dataTables').DataTable({
                "ajax": {
                    "url": "<?php echo site_url('master_data/pembatasanMember') ?>",
                    "type": "POST",
                    "data": function(d) {
        ...
        detailMember(limitTransactionCode) 
        {
            var table= $('#detailDataTables_'+limitTransactionCode).DataTable({
                "ajax": {
                    "url": "<?php echo site_url('master_data/pembatasanMember/getDetailMember') ?>",
                    "type": "POST",
                    "data": function(d) {
        ...
        getDetailMemberExcept(limitTransactionCode) 
        {
            var table= $('#detailDataTables3_'+limitTransactionCode).DataTable({
                "ajax": {
                    "url": "<?php echo site_url('master_data/pembatasanMember/getDetailMemberExcept') ?>",
                    "type": "POST",
                    "data": function(d) {
                        d.limitTransactionCode = limitTransactionCode;
                        d.searchData=document.getElementById(`searchData_${limitTransactionCode}`).value;
        ...
        tableUserLimited() 
        {
            ...
            $('#tableUserLimited').DataTable({
                "ajax": {
                    "url": "<?php echo site_url('master_data/pembatasanMember/getUser') ?>",
                    "type": "POST",
                    "data": function(d) {
        ...
        tableUserExcept() 
        {
            ...
            $('#tableUserLimitedExcept').DataTable({
                "ajax": {
                    "url": "<?php echo site_url('master_data/pembatasanMember/getUserExcept') ?>",
                    "type": "POST",
                    "data": function(d) {
                        // d.idMemberExcept = $("input[name='idMemberExcept[]']").map(function(){return $(this).val();}).get();
                        d.idMemberExcept = arrayUserIdExcept
