...
class PassangerRescheduleTicket extends MY_Controller
{
    public function __construct()
    {
        ...
        logged_in();
        $this->load->model('passangerRescheduleTicketModel', 'passanger');
        $this->load->model('global_model');
        $this->load->library('log_activitytxt');

        $this->_table    = 'app.t_trx_booking';
        $this->_username = $this->session->userdata('username');
        $this->_module   = 'transaction2/passangerRescheduleTicket';
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            'title'             => 'Reschedule Tiket Penumpang',
            'content'           => 'passangerRescheduleTicket/index',
    ...
    public function download_excel()
    {
        ...
        $file_name = 'Tiket Reschedule Penumpang ' . $dateFrom . ' s/d ' . $dateTo;
    ...
    public function download_pdf()
    {
        ...
        $this->load->view('passangerRescheduleTicket/pdf', $data);
    }
}
