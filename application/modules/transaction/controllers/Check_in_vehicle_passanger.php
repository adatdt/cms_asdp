...
class Check_in_vehicle_passanger extends MY_Controller {
    public function __construct() {
        parent::__construct();

        logged_in();
        $this->load->model('check_in_vehicle_passanger_model', 'check_in');
        ...
        $this->_module   = 'transaction/check_in_vehicle_passanger';
    ...
    public function index() {
        ...
        $data = [
            ...
            'title'     => 'Check In Penumpang dalam Kendaraan',
            'content'   => 'check_in_vehicle_passanger/index',
    ...
    public function download_excel() {
        ...
        $dateFrom     = date("Y-m-d", strtotime(trim($this->input->get('dateFrom'))));
		$dateTo       = date("Y-m-d", strtotime(trim($this->input->get('dateTo'))));

        $data = $this->check_in->download();

        $file_name = 'check in Penumpang dalam kendaraan tanggal ' . $dateFrom . ' s/d ' . $dateTo;
