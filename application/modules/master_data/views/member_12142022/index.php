                            ...
                            <div class="col-sm-12 form-inline">
                               ...
                               <div class="input-group pad-top">
                                    <div class="input-group-btn">
                                        <button type="button" class="btn green dropdown-toggle" data-toggle="dropdown" aria-expanded="false" id='btnData' >NIK
                                            <i class="fa fa-angle-down"></i>
                                        </button>
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="javascript:;" onclick="table.changeSearch('NIK','nik')">NIK</a>
                                            </li>

                                            <li>
                                                <a href="javascript:;" onclick="table.changeSearch('Nama','nama')">Nama</a>
                                            </li>

                                            <li>
                                                <a href="javascript:;" onclick="table.changeSearch('No. Telepon','telpon')">No. Telepon</a>
                                            </li>

                                            <li>
                                                <a href="javascript:;" onclick="table.changeSearch('Alamat','alamat')">Alamat</a>
                                            </li>
                                    ...
                                    <!-- /btn-group -->
                                    <input type="text" class="form-control" placeholder="Cari Data" data-name="nik" name="searchData" id="searchData"> 
                                </div>   
                                <div class="input-group pad-top">
...
class myData {
    loadData() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('master_data/member') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "date_of_birth", "orderable": true, "className": "text-left"},
