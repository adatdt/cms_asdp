                 ...
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" required name="dock_fee" id="dock_fee" placeholder="Nama Deramaga" onkeypress="return isNumberKey(event)">
                        </div>

                        <div class="col-sm-6 form-group">
                            <label>Tarif tambat <span class="wajib">*</span></label>
                            <input type="text" class="form-control" required name="tambat_fee" id="tambat_fee" placeholder="Nama Deramaga" onkeypress="return isNumberKey(event)">
                        </div>
