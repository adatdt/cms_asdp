...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('master_data/slider_reservasi') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "order", "orderable": true, "className": "text-center", "width": 5},
                    {"data": "url_target", "orderable": true, "className": "text-center", "width": 5},
										{"data": "detail", "orderable": false, "className": "text-center"},
