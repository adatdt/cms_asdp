...
<div class="col-md-6 col-md-offset-3">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('pids/videoPids/action_edit', 'id="ff" autocomplete="off"'); ?>
            <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            <div class="form-group">
                                ...
                                <?= form_dropdown("port",$port,$portSelected,' class="form-control select2"  placeholder="Pelabuhan" required disabled ')?>
                            </div>
                        ...
                        <div class="col-md-6">                            
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <label>Pilih File video <span class="wajib">*</span></label>
                                <div class="input-group ">
                                    ...
                                    <span class="input-group-addon btn default btn-file">
                                        ...
                                        <input type="hidden"><input type="hidden"><input type="file" name="fileName"  ></span>
                        ...
                        <div class="col-sm-6 ">
                            ...
                            <video src="<?= base_url($detail->path) ?>" controls width="200px"></video>
