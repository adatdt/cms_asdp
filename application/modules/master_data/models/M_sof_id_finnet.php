...
class M_sof_id_finnet extends MY_Model{
    ...
    public function dataList(){
		...
		$where = "where sof_id is not null";

		if(!empty($search['value']))
		{
			$where .=" and (
							sof_name ilike '%".$iLike."%' 
							or sof_id ilike '%".$iLike."%'
							or category ilike '%".$iLike."%'
		...
		$sql 		   = "
							select * from app.t_mtr_sof_id_finnet
							{$where}
						 ";
