                 ...
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <select class="form-control select2" required name="assignment" id="assignment">
                                ...
                                <?php foreach($assignment as $key=>$value ) { ?>
                                    <option value="<?php echo $value->assignment_code ?>"><?php echo strtoupper($value->team_name." - ".$value->assignment_code); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" readonly class="form-control" name="shift_name" id="shift_name" placeholder="Shift" required >
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" required name="port" id="port" readonly placeholder="Pelabuhan">
                            <input type="hidden"  required name="port_id" id="port_id" readonly>
                        </div>

                        <div class="col-sm-6 form-group">
                            <label>Nama Regu</label>
                            <input type="text" class="form-control" required name="team" id="team" readonly placeholder="Regu">
                        </div>
        ...
        $("#date").on("changeDate",function(){
            ...
            $.ajax({
                ...
                success:function(x){
                    ...
                    {
                        isi +="<option value='"+x[i].assignment_code+"'>"+x[i].team_name+" - "+x[i].assignment_code+"</option>";   
                    }
    ...
    function getShift()
    {
        $("#assignment").on("change",function(){
            ...
            $.ajax({
                type:"post",
                data:"assignment_code="+assignment_code,
                url:"<?php echo site_url()?>transaction/opening_balance/get_shift",
                dataType:"json",
                success:function(x){

                    $("#shift_name").val(x.shift_name);
                    $("#shift").val(x.shift_id);
                    // console.log(x);   
                }
            });
