      ...
      .transform2{
        ...
        left: 5%; */
         ...
         <?php 
            ...
            if($vehicle[0]->ticket_type == 2) //tipe tiket 2 itu SAB
            {
                $header ="<b>SKPT</b>";
                $dataPemesan = array(
                    array("label"=>"Nama","data"=> $vehicle[0]->created_by),
                    array("label"=>"Instansi","data"=> $vehicle[0]->customer_name),
                    array("label"=>"Email","data"=> $vehicle[0]->email),
                    array("label"=>"Nomor Telepon","data"=> $vehicle[0]->phone_number),
                );
            }
            else
            {
                ...
                $dataPemesan = array(
                    array("label"=>"Nama","data"=> $vehicle[0]->customer_name),
                    array("label"=>"Email","data"=> $vehicle[0]->email),
                    array("label"=>"Nomor Telepon","data"=> $vehicle[0]->phone_number),
                );
            }

            $getDate=$vehicle[0]->depart_time_start;
            ...
            $scheduleSelectedTime = format_time($vehicle[0]->depart_time_start)." - ".format_time($vehicle[0]->depart_time_end);  
            if($vehicle[0]->ship_class_id==2)
            {
                $scheduleSelectedTime = format_time($vehicle[0]->depart_time_start);  
            }            
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td colspan="3" rowspan="1" >
                                        ...
                                        <?php echo hari_ini(date('D', strtotime($vehicle[0]->depart_date))).", ".format_date($vehicle[0]->depart_date)."<br />".format_time($departStartTime)." - ".format_time($departEndTime) ?>
                                        </div> 
                                    </td>
                                    <td rowspan="3" width="30%" style="text-align:center; vertical-align: text-top; ">
                                        <p style="margin-top:-30px;">
                                            ...
                                            <span style="color: #292929; font-size:13px; ">
                                                Kendaraan - <?= str_replace("GOLONGAN","Gol.",strtoupper($vehicleClassName))  ?> <br>
                                        ...
                                        <?php echo  hariku(date('D', strtotime($vehicle[0]->depart_date))).", ".format_date($vehicle[0]->depart_date)." ".$scheduleSelectedTime ?>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
