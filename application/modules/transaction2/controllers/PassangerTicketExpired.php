...
class PassangerTicketExpired extends MY_Controller{
	public function __construct(){
		parent::__construct();

        logged_in();
        $this->load->model('PassangerTicketExpiredModel','passanger');
	...
	public function index(){   
        ...
        $statusExpired=array(""=>"Pilih",
                            $this->enc->encode(10)=>"CHECKIN EXPIRED",
                            $this->enc->encode(11)=>"GATEIN EXPIRED",
        ...
        $data = array(
            ...
            'title'    => 'Tiket Expired Penumpang',
            'content'  => 'passangerTicketExpired/index',
    ...
    public function download_excel()
    {
        ...
        $file_name = 'Tiket Expired Penumpang tanggal '.$dateFrom.' s/d '.$dateTo;
    ...
    public function download_pdf()
    {
        ...
        // echo "hai";
        $this->load->view('passangerTicketExpired/pdf',$data);
