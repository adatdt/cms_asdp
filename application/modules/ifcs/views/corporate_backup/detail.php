                                        ...
                                        <table class="table table-bordered table-striped   table-hover" id="dataTables">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>REWARD SAAT INI (Rp.)</th>
                                                    <th>REWARD DIGUNAKAN (Rp.)</th>
                                                    <th>TOTAL REWARD DIGUNAKAN (Rp.)</th>
        ...
        loadData: function() {
            $('#dataTables').DataTable({
                ...
                "columns": [
                        ...
                        {"data": "last_remaining_reward", "orderable": true, "className": "text-right"},
                        {"data": "used", "orderable": true, "className": "text-right"},
                        {"data": "total_reward", "orderable": true, "className": "text-right"},
                        {"data": "total_transaction", "orderable": true, "className": "text-center"},
                        {"data": "adjusment_transaction", "orderable": true, "className": "text-center"},
