...
<page backtop="14mm" backbottom="14mm" backleft="-5mm" backright="14mm">
  <page_header>
...
<style type="text/css">
  ...
  <!-- Setting CSS Tabel data yang akan ditampilkan -->
    <table class="tabel full-width font " style="width: 100%" >
        <tr>
            <td colspan="9" style="text-align: center; width:100%">DAFTAR PENUMPANG PADA KENDARAAN</td>
        </tr>

        <tr>
            <td colspan="9">Tanggal : <?php echo format_date($detail->schedule_date) ?></td>
        </tr>

        <tr>
            <td colspan="9">Nama Kapal : <?php echo $detail->ship_name ?></td>
        </tr>
    ...
    <table class="tabel full-width font" style="width: 100%">
        ...
        <tr>
            <td colspan="6">Nama Kapal : <?php echo $detail->ship_name ?></td>
        </tr>
