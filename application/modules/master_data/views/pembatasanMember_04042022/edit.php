                 ...
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" name="startDate" id="dateFrom" class="form-control " required placeholder="YYYY-MM-DD HH:MM" readonly value="<?= $detail->start_date ?>" >                       
                        </div>

                        <div class="col-sm-4 form-group">
                            <label>Tanggal Akhir<span class="wajib">*</span></label> 
                            <input type="text" name="endDate" id="dateTo" class="form-control " required placeholder="YYYY-MM-DD HH:MM" readonly  value="<?= $detail->end_date ?>" >                       
                        </div>
