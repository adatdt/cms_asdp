                 ...
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group" id="div_posPairing" style="display: none">
                            ...
                            <?= form_dropdown("posPairing",$dataPairingPos,$selectedDataPairingPos, ' id="posPairing" class="form-control   select2 "  required style="width: auto" ') ?>
                        </div>
...
<script type="text/javascript">
    ...
    if(device_type == 1 || device_type == 2 || device_type == 4 || device_type == 5 || device_type== 3 || device_type == 12 || device_type == 19) {
        $("#div_dock").hide();
        $("#div_imei").hide();
        $("#div_ship_class").show();
