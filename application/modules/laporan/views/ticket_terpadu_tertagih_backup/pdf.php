...
<page backtop="30mm" backbottom="0mm" backleft="7mm" backright="7mm">
	...
	<table class="tabel full-width" align="center">
		...
		<tr>
			...
			<td style="border-left: none !important;" colspan="3">: <b><?= strtoupper($status_approve) ?></b></td>
		</tr>
	</table>
	...
	<table class="tabel full-width" style="width: 100% !important">
		...
		<tr>
			<td colspan="3" style="border-right: 0px;"><b>Sub Total</b></td>
			<td style="text-align: right"><b><?= idr_currency($produksi_ifcs_reedem) ?></b></td>
			<td style="text-align: right"><b><?= idr_currency($pendapatan_ifcs_reedem) ?></b></td>
		</tr>
	</table>
	...
	<table class="tabel full-width" style="width: 100% !important">
		...
		<tr>
			...
			<td style="text-align: right"><b><?= idr_currency($produksi_tunai + $produksi_cashless + $produksi_online + $produksi_ifcs + $produksi_ifcs_reedem + $produksi_b2b) ?></b></td>
			<td style="text-align: right"><b><?= idr_currency($pendapatan_tunai + $pendapatan_cashless + $pendapatan_online + $pendapatan_ifcs + $pendapatan_ifcs_reedem + $pendapatan_b2b) ?></b></td>
		</tr>
	</table>
