...
<div class="col-md-6 col-md-offset-3">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('master_data/batch/action_add', 'id="ff" autocomplete="off"'); ?>
            <div class="box-body">
                <div class="form-group">
                    <!-- <div class="row">
                        <div class="col-sm-6 form-group">
                            <label>Kode Batch <span class="wajib">*</span></label>
                            <input type="text" name="batch_code" class="form-control"  placeholder="Kode Batch" minlength="4" maxlength="4" required>
                        </div>

                        <div class="col-sm-6 form-group">
                            <label>Nama Batch <span class="wajib">*</span></label>
                            <input type="text" name="batch_name" class="form-control"  placeholder="Nama Batch" required>
                        </div>
                    </div> -->
                    <div class="row">
                        <div class="col-sm-6 form-group">
