...
class Ticket_tertagih_model extends CI_Model
{
	...
	public function list_data($port, $datefrom, $dateto, $petugas, $shift, $ship_class, $type, $vm = "", $merchant = "")
	{
		$where_port = "";
		$where_petugas = "";
		$where_shift = "";
						...
						FROM
							...
							LEFT JOIN ( SELECT
										...
										FROM
											...
											JOIN app.t_trx_boarding_passanger BOP ON OBO.boarding_code = BOP.boarding_code AND BOP.status = 1
											JOIN app.t_trx_booking_passanger BKP ON BKP.ticket_number = BOP.ticket_number AND BKP.service_id = 1 $where_ship_class
											JOIN app.t_trx_booking BO ON BO.booking_code = BKP.booking_code AND BO.channel IN ( 'web', 'mobile' )
