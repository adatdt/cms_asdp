...
class M_pos_auth extends MY_Model{
    ...
    public function dataList(){
		...
		$where = " WHERE a.status<>'-5' and d.status<>'-5' ";

		if(!empty($search['value']))
		{
			$where .="and (	
							a.action_code ilike '%".$iLike."%'
		...
		$sql 		   = "
							SELECT d.description, b.name as port_name, c.name as group_name, a.* from app.t_mtr_action_auth a
							left join app.t_mtr_port  b on a.port_id=b.id
							left join core.t_mtr_user_group c on a.user_group_id = c.id
							left join app.t_mtr_action d on a.action_code=d.action_code
							{$where}
						 ";
