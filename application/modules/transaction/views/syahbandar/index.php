...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <?php $now=date("Y-m-d"); $last_week=date('Y-m-d',strtotime("-0 days")); $last_day=date('Y-m-d',strtotime("-0 days")) ?>
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 form-inline">
                                                    ...
                                                    <div class="input-group pad-top">
                                                        <?php if ($btn_excel) {?>
                                                            <button  class="btn btn-md btn-warning download" id="download_excel" disabled>Excel</button>
                                                        <?php } ?>
                                                    </div>                                                                                                                    
                                                </div>
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-sm-12 form-inline">
                                                    ...
                                                    <div class="input-group pad-top">
                                                        <div class="input-group-btn">
                                                            <button type="button" class="btn green dropdown-toggle" data-toggle="dropdown" aria-expanded="false" id='btnData2' >Kode Boarding
                                                                <i class="fa fa-angle-down"></i>
                                                            </button>
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a href="javascript:;" onclick="myData.changeSearch2('Kode Boarding','boardingCode')">Kode Boarding</a>
                                                                </li>                                                        
                                                                <li>
                                                                    <a href="javascript:;" onclick="myData.changeSearch2('Nama Kapal','shipName')">Nama Kapal</a>
                                                                </li>                                                        
                                                                                         
                                                            </ul>
                                                        </div>
                                                        <!-- /btn-group -->
                                                        <input type="text" class="form-control" placeholder="Cari Data" data-name="boardingCode" name="searchData" id="searchData2" autocomplete="off"> 
                                                    </div>                          
                                                    ...
                                                    <div class="input-group pad-top">
                                                        <?php if ($btn_excel) {?>
                                                            <button  class="btn btn-md btn-warning download" id="download_excel2" disabled>Excel</button>
                                                        <?php } ?>
                                                    </div>        
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#download_excel").click(function(event){
            ...
            window.location.href="<?php echo site_url('transaction/syahbandar/download_excel?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port_origin="+port_origin+"&port_destination="+port_destination+"&searchData="+searchData+"&status=0"+"&searchName="+searchName;
        });
        ...
        $("#download_excel2").click(function(event){
            ...
            var searchData2=$('#searchData2').val();
            var searchName2=$("#searchData2").attr('data-name');

            window.location.href="<?php echo site_url('transaction/syahbandar/download_excel?') ?>dateFrom="+dateFrom2+"&dateTo="+dateTo2+"&port_origin="+port_origin2+"&port_destination="+port_destination2+"&searchData="+searchData2+"&status=1"+"&searchName="+searchName2;
        });        
