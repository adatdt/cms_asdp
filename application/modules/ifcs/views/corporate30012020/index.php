...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('ifcs/corporate') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "corporate_address", "orderable": true, "className": "text-left"},
                    {"data": "description", "orderable": true, "className": "text-left"},
                    {"data": "pic_name", "orderable": true, "className": "text-center"},
                    {"data": "pic_position", "orderable": true, "className": "text-center"},
                    {"data": "pic_email", "orderable": true, "className": "text-center"},
                    {"data": "pic_phone", "orderable": true, "className": "text-center"},
                    {"data": "status", "orderable": true, "className": "text-center"},
                    {"data": "notif", "orderable": true, "className": "text-center"},
