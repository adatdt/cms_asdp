...
<page_header>
    ...
    <p style=" text-align: center; ">
        ...
        <h4>
            Ticket Expired Kendaraan Keberangkatan <?php  echo format_date($departDateFrom) ." s/d ".format_date($departDateTo) ?>
 ...
 <table class="my-table font-small" border="1" >
    ...
    ?>        
            <tr>
                ...
                <td style="width: 15%"><?php echo  $value->route_name ?></td>
                <td><?php echo  wordwrap($value->description, 30, '<br />', true)  ?></td>
                <td><?php echo  $value->description_expired ?></td>
            </tr>  
