...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('ifcs/reward_sector') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "tier", "orderable": true, "className": "text-left"},
                    {"data": "min", "orderable": true, "className": "text-right"},
                    {"data": "max", "orderable": true, "className": "text-right"},
                    {"data": "reward_value", "orderable": true, "className": "text-center"},
