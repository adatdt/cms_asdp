                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 form-inline">
                                            ...
                                            <div class="input-group select2-bootstrap-prepend pad-top">
                                                ...
                                                <?= form_dropdown("port",$port,""," class='form-control  input-small select2' id='port' ") ?>
                                            </div>

                                            <div class="input-group select2-bootstrap-prepend pad-top">
                                                <div class="input-group-addon">Layanan</div>
                                                <?= form_dropdown("shipClass",$shipClass,""," class='form-control  input-small select2' id='shipClass' ") ?>
                                            </div>                                            

                                           <div class="input-group pad-top">
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn green dropdown-toggle" data-toggle="dropdown" aria-expanded="false" id='btnData' >Kode PCIS
                                                        <i class="fa fa-angle-down"></i>
                                                    </button>
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="javascript:;" onclick="myData.changeSearch('Kode PCIS','pcisCode')">Kode PCIS</a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:;" onclick="myData.changeSearch('Request','request')">Request</a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:;" onclick="myData.changeSearch('Response','response')">Response</a>
                                                        </li>                               
                                                    </ul>
                                                </div>
                                                <!-- /btn-group -->
                                                <input type="text" class="form-control" placeholder="Cari Data" data-name="pcisCode" name="searchData" id="searchData"> 
                                            </div>   
                                            <div class="input-group pad-top">
