...
<page backtop="30mm" backbottom="8mm" backleft="7mm" backright="7mm">
	...
	<table class="tabel full-width" align="center">
		<tr>
			...
			<th class="center bold" style="width: 25%">TARIF (90% * Dmg)</th>
			<th class="center bold" style="width: 17%">Produksi (Lbr)</th>
			<th class="center bold" style="width: 18%">Pendapatan (Rp.)</th>
			</tr>
					<tr>
			...
			$filename = strtoupper("Dermaga_infinity_" . $cabang . "_" . $this->input->get('datefrom') . "_" . $this->input->get('dateto'));
			try
			{
