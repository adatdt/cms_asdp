                 ...
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            <input type="text" name="startDate" class="form-control " id="dateFrom" required placeholder="YYYY-MM-DD HH:MM" readonly >                       
                        </div>

                        <div class="col-sm-3 form-group">
                            <label>Tanggal Akhir<span class="wajib">*</span></label> 
                            <input type="text" name="endDate" class="form-control " id="dateTo" required placeholder="YYYY-MM-DD HH:MM" readonly >                       
                        </div>
