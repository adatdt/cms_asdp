...
<!--                         <div class="col col-md-4"><a class=" btn btn-sm btn-warning" id="add_user" >Tambah User</a></div>
                        ...
                        <div class="col-sm-12" > 
                            <div style="padding:0px; " >
                                <div class="add_field_button btn btn-warning pull-right btn-sm" ><i class="fa fa-plus"></i></div>
                            </div>
    ...
    $(document).ready(function(){
        ...
        $(add_button).click(function(e){ //on add input button click
            ...
            if(x < max_fields){ //max input box allowed
                ...
                $(wrapper).append('<div class="remove_user"><a href="#" class="remove_field pull-right">Hapus</a><select id="username'+x+'" name="user['+x+']" class="form-control select2" required>'+data_option2+'</select></div>'); //add input box
