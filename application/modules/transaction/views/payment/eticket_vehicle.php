<html>
      ...
      .transform2{
        ...
        left: 5%; */
         ...
         <?php 
            ...
            if($vehicle[0]->channel =='web_admin' ) //nama channel SAB
            {
                // $header ="<b>SAB</b>";
                $header ="<b>SKPT</b>";
            ...
            {
                if(strtoupper($vehicle[0]->channel) =="IFCS" )
                {
            ...
            <main>
                <p style="page-break-after: never;">
                    <div width="100%">
                                ...
                                <tr >
                                    <td rowspan="3" width="20%" style="text-align:center; padding-right:10px;">
                                        <div style="margin-top:-35px;" >
                                            ...
                                            <hr>
                                            <span class="text-big2" style="color:#f88f27; font-weight:bold;"><?= $vehicle[0]->booking_code; ?></span><br>
                                    ...
                                    <td colspan="3" rowspan="1" >
                                        ...
                                        <?php 
                                            $date = format_date($vehicle[0]->depart_date);
                                            $checkin_start = strtotime($vehicle[0]->depart_time_start."-".$checkinStart." hours");
                                            $checkin_end   = strtotime($vehicle[0]->depart_time_start."+".$checkinEnd." hours");
                                            $time_start    = date('H:i',$checkin_start);
                                            $time_end      = date('H:i',$checkin_end);
                                        ?>
                                            <div style="font-size:13px; font-weight: bold;  padding-top:5px;">
                                              <?php echo hariku(date('D', strtotime($vehicle[0]->depart_date))).",$date<br />$time_start - $time_end" ?>
                                            </div> 
                                    </td>
                                    <td rowspan="3" width="30%" style="text-align:center; vertical-align: text-top; ">
                                        <p style="margin-top:10px;">
                                            <!-- <h1 style="color:#4B77BE;"><?= $vehicle[0]->ship_class ?></h1> -->
                                            <?php 
                                                if($vehicle[0]->ship_class_id == 2){                    
                                                    echo '<h1 style=" font-size:26px;color: #4B77BE;"><b>';
                                                    echo $vehicle[0]->ship_class ;
                                                    echo '</b></h1>';
                                                }
                                                else{
                                            ...
                                            ?>
                                            <span style="color: #292929; font-size:13px; ">
                                                Kendaraan - <?= str_replace("GOLONGAN","Gol.",strtoupper($vehicle[0]->vehicle_name))  ?> <br>
                                                Nomor Polisi - <?= $vehicle[0]->id_number ?>
                                            </span>                                           
                                        </p>
                                        <p></p>
                                        <p></p>
                                        ...
                                        <?php 
                                            $date = format_date($vehicle[0]->depart_date);
                                            $shipClass = $vehicle[0]->ship_class_id;
                                            $schedule ="";
                                            if ($shipClass == 2){
                                                $schedule = $date ." ". format_time($vehicle[0]->depart_date . " " . $vehicle[0]->depart_time_start);
                                            }else{
                                                $schedule = $date ." ". format_time($vehicle[0]->depart_date . " " . $vehicle[0]->depart_time_start)." - ".format_time($vehicle[0]->depart_time_end);
                                            }
                                        ?>    
                                        <p class="text-small-grey">Jadwal yang Dipilih<br>
                                        <?php echo  hariku(date('D', strtotime($vehicle[0]->depart_date))).", ". $schedule?>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td >
                                        <?= $vehicle[0]->origin ?><br>
                                        <span class="text-small-grey"><?= $vehicle[0]->origin_city ?></span>
                                    </td>
                                    <td >
                                        <img   src="data:image/png;base64,<?= $imageShip ?>" style="height:40px;width:auto;" >    
                                    </td>
                                    <td >
                                        <?= $vehicle[0]->destination ?><br />
                                        <span class="text-small-grey"><?= $vehicle[0]->destination_city ?></span>
                        ...
                        if(!empty($dataVaccine[$value->ticket_number_passanger])){
                            $vaccine = $dataVaccine[$value->ticket_number_passanger];
                            ...
                            $rowVaccine = '
                                ...
                                if($vaccine->config_test == "t")
                                {
                                    $textResult = "-";
                                    $resultTest ="";
                                    if(!empty($dataTestStatus[$value->ticket_number_passanger]))
                                    {
                                        $testCovid = $dataTestStatus[$value->ticket_number_passanger];
                                        $resultTest = $testCovid->result;
                                        $textResult = strtoupper($testCovid->type).", ".$testCovid->result." ".format_date($testCovid->date)." ".date("H:i:s",strtotime($testCovid->date));
                                    }
                        ...
                        ?>  
                            <tr style="background-color:#f2f2f2; ">
                                ...
                                <td style="width:25%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">: <?= $vehicle[0]->created_by ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width:75%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">: <?= $vehicle[0]->customer_name ?>
                                </td>
                            ...
                            <tr  style="background-color:#f2f2f2; " >
                                ...
                                <td style="width:75%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">: <?= $vehicle[0]->email ?>
                                </td>
                            </tr>    
                            <tr>
                                <td style="width:25%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">
                                ...
                                <td style="width:75%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">: <?= $vehicle[0]->phone_number ?>
                                </td>
                            </tr> 
                        <?php } else { ?>
                            <tr style="background-color:#f2f2f2; ">
                                ...
                                <td style="width:25%; text-align:justify; padding:8px 0px 8px 0px; font-size:12px;" valign="top">: <?= $vehicle[0]->customer_name ?>
                                </td>
  ...
  <?php
        ...
        $dompdf->add_info('Title', 'Tiket Online '.$vehicle[0]->booking_code);
        $dompdf->stream('Tiket_Online_'.$vehicle[0]->booking_code.".pdf", array("Attachment" => false));
