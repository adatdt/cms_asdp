...
class M_gambar_asset extends MY_Model{
    ...
    public function dataList(){
		...
		// $where = " where a.module != 'slider_web_reservasi' and status = 1";
		$where = " where a.module not in  ('slider_web_reservasi','slider_popup') and status = 1";
		...
		$sql 		   = "
									select a.id, a.module, a.name, a.path, a.desc, a.active, a.order, a.url_target from app.t_mtr_banner a
										{$where}
								 ";
