                                            ...
                                            <table class="table table-bordered table-striped   table-hover" id="table_penumpang" >
                                                ...
                                                <?php $no1=1; foreach($detail_passanger as $key=>$value ) {  ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo empty($value->open_boarding_date)?"":format_dateTime($value->open_boarding_date); ?></td>
...
<script type="text/javascript">
    ...
    $("#btndpdf").click(function(event)
    {
        ...
        window.open("<?php echo site_url('transaction/gs/download_pdf?boarding_code=')?>"+boarding+"&n=normal");
    ...
    $("#btndpdf2").click(function(event){
        ...
        var boarding="<?php echo $code?>";
        window.open("<?php echo site_url('transaction/gs/download_pdf?boarding_code=')?>"+boarding+"&n=summary");

    });    

    $("#btndownload").click(function(event){

        window.location.href="<?php echo site_url('transaction/gs/download/'.$code) ?>";
    });

    $("#btndownload2").click(function(event){

        window.location.href="<?php echo site_url('transaction/gs/download_vehicle/'.$code) ?>";
    });

    $("#btndownload3").click(function(event){

        window.location.href="<?php echo site_url('transaction/gs/download_vehicle_passanger/'.$code) ?>";
    });
    ...
    $.ajax({
            url         : "<?php echo site_url()?>transaction/gs/approve",
            type        : 'post',
            data        :"code="+code,
            dataType    : 'json',
