                                           ...
                                           <div class="input-group pad-top">
                                                <div class="input-group-btn">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <?php }?>
                                                        <li>
                                                            <a href="javascript:;" onclick="myData.changeSearch('Perangkat','deviceName')">Perangkat</a>
                                                        </li>
                                                        <li>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#download_excel").click(function(event){
            ...
            window.location.href="<?php echo site_url('transaction/check_in_vehicle/download_excel?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port="+port+"&searchData="+searchData+"&searchName="+searchName;
        });
