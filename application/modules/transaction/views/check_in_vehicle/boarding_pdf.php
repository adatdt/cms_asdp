...
<?php
    ...
    $golongan = str_replace("GOLONGAN", "",strtoupper($data->vehicle_class_checkin));
    ...
    */
    ...
    // $waterMark = "WWWWWWWWWWWWWWWWWWWWWWWWWWW";
...
<body>
    ...
    <div width="100%"   style="padding:10px;">
        ...
        <tbody>
            ...
            <tr>
                <td   class="text-big"><div style="margin-top:-25px;"><?= $golongan; ?></div></td>
                <td ></td>
            ...
            <tr>
                ...
                <td colspan=2 class="text-body" ><div style="padding-left:50px;" >: <?= date("d - m - Y H:i:s", strtotime($data->boarding_expired))?> </div></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="text-body">NO. POLISI</td>
                <td colspan=2 class="text-body"><div style="padding-left:50px;" >:  <?= $data->id_number; ?></div></td>
            </tr>
            <tr>
                <td class="text-body">GOLONGAN</td>
                <td colspan=2 class="text-body"><div style="padding-left:50px;" >:  <?= $golongan; ?></div></td>
            </tr>
            <tr>
                <td class="text-body">BERAT</td>
                <td colspan=2 class="text-body"><div style="padding-left:50px;" >: <?= $data->weight; ?> KG</div></td>
            </tr>
            <tr>
                <td colspan="3"></td>
            </tr>            
