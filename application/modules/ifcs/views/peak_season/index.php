                        ...
                        <div class="row">
                            <div class="col-md-12"> 
                                ...
                                <div class="input-group select2-bootstrap-prepend">
                                    ...
                                    <?php echo form_dropdown('port',$port,'',' class="form-control select2" id="port" '); ?>
                                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="dataTables">
                        <thead>
                            ...
                            <tr>
                                <th>NO</th>
                                <th>PELABUHAN</th>
                                <th>AWAL PEAK SEASON</th>
                                <th>AKHIR PEAK SEASON</th>
                                <th>KETERANGAN</th>
                                <th>STATUS</th>
                                <th>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('ifcs/peak_season') ?>",
                "type": "POST",
                "data": function(d) {
