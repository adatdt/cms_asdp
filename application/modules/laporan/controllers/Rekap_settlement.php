...
class Rekap_settlement extends MY_Controller {
    ...
    function __construct() {
 	...
 	function index() {
        ...
        $data['btnDownload']   = $this->model->button_download(uri_string());
        $data['tab']           = array('Rekap Settlement');
        $data['fill_tab']      = array('rekap');
        $data['content']       = "rekap_settlement/index";
    ...
    function listSettlement(){
        ...
        echo $res = json_api(1,'Rekap settlement',$data);
         /* Fungsi Create Log */
        $createdBy   = $this->session->userdata('username');
        $logUrl      = site_url().'laporan/rekap_settlement';
        $logMethod   = 'ADD';
