...
<!--                         <div class="col-sm-1 form-group">
 ...
 -->
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="email" name="pic_email" class="form-control"  placeholder="Email PIC" required>
                        </div>                         

                        <div class="col-sm-6 form-group">
                            <label>Nomer Telpon PIC<span class="wajib">*</span></label>
                            <input type="text" name="pic_phone" class="form-control"  placeholder="Nomer Telpon PIC" onkeypress="return isNumberKey(event)" maxlength="16" required>
                        </div>                         
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        messages= {email: "Format email tidak valid",
                nik: {minlength: jQuery.validator.format("Minimal {0} Karakter")}
                };
