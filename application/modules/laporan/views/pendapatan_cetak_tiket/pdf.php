...
<page backtop="32mm" backbottom="10mm" backleft="0mm" backright="0mm">
    ...
    <table class="tabel full-width tabel-detail" align="center">
        <tr>
            <th class="center bold" style="width: 5%">NO</th>
            <th class="center bold" style="width: 45%">NAMA KAPAL</th>
            <th class="center bold" style="width: 15%">PRODUKSI <br>(Lbr)</th>
            <th class="center bold" style="width: 20%">PENDAPATAN<br>(Rp)</th>
            <th class="center bold" style="width: 15%">KET</th>
        </tr>
        <tr>
        ...
        ?>
            <tr>
                ...
                <td class="right">
                    <?= idr_currency($value->ticket_count) ?>
                </td>
                <td class="right">
                    <?= idr_currency($value->adm_fee) ?>
                </td>
               <td></td>
            </tr>
        <?php } ?>
        <tr>
            ...
            <td class="right bold">
                <?= idr_currency($data['totalTicket']) ?>
            </td>
            <td class="right bold">
                <?= idr_currency($data['totalAdmfee']) ?>
            </td>
            <td class="right bold">
            </td>
        </tr>
    ...
    <table class="table table-no-border full-width" align="center">
        <tr>
            ...
            <td class="center" style="padding-bottom: 0"><?php echo ucwords(strtolower($param[3])) . ", " . format_date($param[0]) ?></td>
        </tr>
        <tr>
            <th class="center"></th>
            <th class="center"></th>
