                            ...
                            <div class="row">
                                ...
                                <!--                                 <div class="col-lg-2 col-md-4 col-xs-12">
                                    <div class="mt-element-ribbon bg-grey-steel">
                                        ...
                                        <p class="ribbon-content"><?php echo $status_syahbandar; ?></p>
                                    </div>
                                </div>
 -->
                                <div class="col-lg-3 col-md-4 col-xs-12">
                                ...
                                <div class="col-lg-3 col-md-4 col-xs-12">
                                    <div class="mt-element-ribbon bg-grey-steel">
                                        ...
                                        <p class="ribbon-content"><?php
                                                                    // echo array_sum($tot_pass);
                                                                    echo sizeof($detail_passanger_vehicle)
                        ...
                        <div class="col-md-12">
                            ...
                            <!-- <button class="btn  btn-sm btn-primary" id="btnapprove" >approve</button> -->

                            <!-- jika mempunyai aksess edit maka approve akan muncul -->
                            <?php if ($btn_akses) {
                                // jika belum di approve maka akan muncul
                                if ($btn == 0) {
                                    // jika sudah close ramdoor akan muncul
                                    // if($status_close_rampdoor>0)
                                    // {
                                    echo $approval;

                            ?>

                                    <button class="btn btn-sm btn-warning" onclick="confirmApprove('Apakah anda ingin menyetujui keberangkatan ?')" title="Nonaktifkan" id="btnapprove">Approve</button>
                            ...
                            <?php   if($btn_pdf)
                            {
                                ...
                                $btn ==1?$access=" id='btndpdf' ":$access=" id='btndpbf' onclick='validation()' "; 
                                $btn ==1?$access2=" id='btndpdf2' ":$access2=" id='btndpbf2' onclick='validation()' "; 
                            ?>

                            <div class="btn-group">
                                <button class="btn btn-warning dropdown-toggle btn-sm" type="button" data-toggle="dropdown" aria-expanded="false">
                                    Download PDF
                                    <i class="fa fa-angle-down"></i>
                                </button>
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="javascript:;" <?php echo $access ?> > Detail Manifest Pdf </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" <?php echo $access2 ?> > summary Manifest Pdf </a>
                                    </li>                                                    
                                </ul>
                            </div>
                                    ...
                                    <div class="tab-content ">
                                        ...
                                        <?php } ?>
                                            ...
                                            <table class="table table-bordered table-striped   table-hover" id="table_penumpang">
                                                ...
                                                <tbody id="data_body">
                                                    <?php $no1 = 1;
                                                    foreach ($detail_passanger as $key => $value) {  ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo empty($value->open_boarding_date) ? '' : format_dateTimeHis($value->open_boarding_date); ?></td>
                                                            <td><?php echo empty($value->boarding_date) ? "" : format_dateTimeHis($value->boarding_date); ?></td>
                                                            <td><?php echo empty($value->sail_date) ? "" : format_dateTimeHis($value->sail_date); ?></td>
                                        ...
                                        <?php if ($btn_excel) { ?>
                                            <!-- <button class="btn  btn-sm btn-warning" id="btndownload2" >Excel</button> -->
                                        <?php } ?>
                                            <p></p>
                                        ...
                                        <div class="tab-pane" id="penumpang_kendaraan" role="tabpanel" style="padding: 10px">
                                            <?php if ($btn_excel) { ?>
                                                                                        <!-- <button class="btn  btn-sm btn-warning" id="btndownload3"x >Excel</button> -->
                                        <?php } ?>
                                                <p></p>
                                                <table class="table table-bordered table-striped   table-hover" id="table_penumpang_kendaraan">
                                                    ...
                                                    <tbody id="data_body">
                                                        <?php $no3 = 1;
                                                        foreach ($detail_passanger_vehicle as $key => $value) { ?>
                                                ...
                                                <input type="hidden" id="csrfToken" value="<?php echo $this->security->get_csrf_hash(); ?>" >
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $("#btndpdf").click(function(event)
        {
            ...
            window.open("<?php echo site_url('transaction/boarding/download_pdf?boarding_code=')?>"+boarding+"&n=normal");

        });

        $("#btndpdf2").click(function(event){
            var boarding="<?php echo $code?>";
            window.open("<?php echo site_url('transaction/boarding/download_pdf?boarding_code=')?>"+boarding+"&n=summary");
        ...
        $("#btndownload2").click(function(event) {
            ...
            window.location.href = "<?php echo site_url('transaction/boarding/download_vehicle/' . $code) ?>";
        });

        $("#btndownload3").click(function(event) {

            window.location.href = "<?php echo site_url('transaction/boarding/download_vehicle_passanger/' . $code) ?>";
        });
        ...
        //         dataType:"json",
        //         data:"code="+code,
        //         url:"<?php echo site_url() ?>transaction/boarding/approve",
        //         success:function(x)
        //         {
        //             // console.log(x);
        //             if(x==1)
        ...
        function approveData() {
            ...
            $.ajax({
                url: "<?php echo site_url() ?>transaction/boarding/approve",
                type: 'post',
                data: "code=" + code +"&"+csrfName+"="+csrfToken,
                dataType: 'json',
                ...
                success: function(json) {
                    ...
                    if (json.code == 1) {
                        ...
                        // send message socket
                        socket.emit('approve_manifest', {
                            ship_name: '<?php echo $get_ship_name->ship_name; ?>',
                            dock_name: '<?php echo $get_ship_name->dock_name; ?>',
                            message: 'manifest telah diapprove',
                            created_by: '<?php echo strtoupper($this->session->userdata('username')); ?>',
                            created_on: new Date()
                        });

                        //send data manifest to middleware asdp (siwasops)
                        $.ajax({
                            url: "<?php echo site_url() ?>transaction/boarding/send_manifest/1",
                            type: 'post',
                            data: {
                                code: code,
                                desc: 'SEND',
                                "<?php echo $this->security->get_csrf_token_name(); ?>":json.tokenHash
                            },
                            dataType: 'json',
                            success: function(x) {
        ...
        $(document).ready(function() {
            ...
            const t1 = $("#table_penumpang").DataTable({
            ...
            t1.on( 'draw.dt', function () {
                var PageInfo = $('#table_penumpang').DataTable().page.info();
                t1.column(0, { page: 'current' }).nodes().each( function (cell, i) {
                    cell.innerHTML = i + 1 + PageInfo.start;
                } );
            } );     

            const t2 = $("#table_penumpang_kendaraan").DataTable({
            ...
            t2.on( 'draw.dt', function () {
                var PageInfo = $('#table_penumpang_kendaraan').DataTable().page.info();
                t2.column(0, { page: 'current' }).nodes().each( function (cell, i) {
                    cell.innerHTML = i + 1 + PageInfo.start;
                } );
            } );                 

            const t3 = $("#table_kendaraan").DataTable({
            ...
            t3.on( 'draw.dt', function () {
                var PageInfo = $('#table_kendaraan').DataTable().page.info();
                t3.column(0, { page: 'current' }).nodes().each( function (cell, i) {
                    cell.innerHTML = i + 1 + PageInfo.start;
                } );
            } );                  
