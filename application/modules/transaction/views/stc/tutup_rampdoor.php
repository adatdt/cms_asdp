...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('transaction/stc/action_close_rampdoor', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-2 form-group">
                                ...
                                <button class="btn btn-primary form-control"  >Tutup Ramdor</button>
                        </div>

                        <div class="col-sm-2 form-group">
                                <label>Jam : <?php echo $sail_date; ?></label>
                                <button  class="btn btn-default form-control" disabled >Berlayar</button>
                        </div>
