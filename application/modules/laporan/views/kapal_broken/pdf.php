...
<page backtop="10mm" backbottom="10mm" backleft="8mm" backright="8mm">
    ...
    <table class="tabel full-width" align="center">
        <tr>
            ...
            <td class="col-title bold" style="width: 20%">TANGGAL BROKEN</td>
            <td class="col-title bold" style="width: 15%">DERMAGA</td>
            <td class="col-title bold" style="width: 20%">TARIF</td>
            <td class="col-title bold" style="width: 20%">PRODUKSI<br>(GRT/CALL)</td>
            <td class="col-title bold" style="width: 20%">PENDAPATAN</td>
        </tr>
...
$filename = strtoupper('Laporan_broken_' . $detail->ship_name . "_" . $data['tanggal']);
try {
    // setting paper
