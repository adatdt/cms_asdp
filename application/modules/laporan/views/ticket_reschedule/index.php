                    ...
                    <table class="tabel full-width" align="center">
                        <tr>
                            ...
                            <td rowspan="4" class="center bold" style="width: 60%;font-size: 14pt; line-height: 1.5">
                                <span> LAPORAN TIKET RESCHEDULE</span>
                            </td>
...
<script>
    jQuery(document).ready(function() {
        ...
        $("#excelDownload").click(function() {
            ...
            window.open("<?php echo site_url('laporan/ticket_reschedule/download_excel?') ?>" + url_download);
        });
        ...
        $("#pdfDownload").click(function() {
            var datefrom = $("#datefrom").val(),
                ...
                ship_classku = $("#ship_class option:selected").text();
            var url_download = `datefrom=${datefrom}&dateto=${dateto}&port=${port}&ship_class=${ship_class}&channel=${channel}&portname=${portname}&ship_classku=${ship_classku}`;
            window.open("<?php echo site_url('laporan/ticket_reschedule/download_pdf?') ?>" + url_download);
        });
        ...
        function getData() {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('laporan/ticket_reschedule') ?>",
                dataType: 'json',
                data: {
        ...
        function create_table(data) {
            ...
            for (var num = 0; num < data.length; num++) {
                ...
                html += `
                    <tr class="bold center">
                        ...
                        <td colspan="3">Biaya Administrasi + Reschedule</td>
                    </tr>
                    <tr class="bold center">
                        <td>Biaya Admin</td>
                        <td>Biaya Reschedule</td>
                        <td>Total</td>
                    </tr>
                `;
                ...
                $.each(dataChannel.data, function(k, v) {
                    ...
                    $.each(v.data, function(kc, vc) {
                        ...
                        stRescheduleFee += Number(vc.reschedule_fee);
                        ...
                        html += `
                            <tr>
                                ...
                                <td class="right">${formatIDR(vc.reschedule_fee)}</td>
                    ...
                    html += `
                        <tr class="bold">
                            ...
                            <td class="right">${(isNaN(stRescheduleFee)) ? 0 : formatIDR(stRescheduleFee)}</td>
                    ...
                    totRescheduleFee += Number(stRescheduleFee);
                ...
                html += `
                    <tr class="bold">
                        ...
                        <td class="right">${(isNaN(totRescheduleFee)) ? 0 : formatIDR(totRescheduleFee)}</td>
                ...
                trtRescheduleFee += Number(totRescheduleFee);
            ...
            html += `
                <tr class="bold">
                    ...
                    <td class="right">${(isNaN(trtRescheduleFee)) ? 0 : formatIDR(trtRescheduleFee)}</td>
