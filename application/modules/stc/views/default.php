...
<head>
  ...
  <title><?php if (isset($title) && $title != '') {
            echo $title . ' (' . idtyApp() . ') - ';
          } ?> ASDP Indonesia Ferry (Persero)</title>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/stc/css/fonts/flaticon/flaticon.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/global/plugins/flat-icon/flaticon.css" rel="stylesheet" type="text/css" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/stc/js/alertify/css/alertify.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/stc/js/alertify/css/themes/default.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/stc/css/stc.css?ver=2.0.4">
  ...
  <script src="<?php echo base_url(); ?>assets/stc/js/alertify/alertify.min.js" type="text/javascript"></script>
  <script src="<?php echo base_url(); ?>assets/stc/js/app.js" type="text/javascript"></script>
  ...
  <script type="text/javascript">
    ...
    function date_time(id) {
      ...
      result = days[day] + ', ' + d + ' ' + months[month] + ' ' + year + ' <span class="times">' + h + ':' + m + ':' + s + '</span>';
...
<body class="page-header-fixed page-content-white page-sidebar-closed">
  <div class="page-wrapper">
    ...
    <!-- <div class="page-footer">
      <div class="page-footer-inner" style="color:#c9cdd3">
        Ship Traffic Control ver. 2.0
      </div>
