...
<page backtop="30mm" backbottom="10mm" backleft="8mm" backright="8mm">
	...
	<table class="tabel full-width" style="width: 100% !important; min-width: 100% !important">
		...
		foreach ($data as $row) {
			...
			foreach ($row['data'] as $rowA) {
				...
				foreach ($rowA['data'] as $k => $v) {
					...
					echo '
						<tr>
							...
							<td class="right">' . $v->reschedule_fee . '</td>
				...
				<tr class="bold">
					...
					<td class="right">' . $cRescheduleFee1 . '</td>
			...
			<tr class="bold">
				...
				<td class="right">' . $cRescheduleFee2 . '</td>
		...
		<tr class="bold">
			...
			<td class="right">' . $cRescheduleFee3 . '</td>
...
$filename = strtoupper("Laporan_tiket_reschedule_" . $portname . "_" . format_date($datefrom) . "_" . format_date($dateto) . "_" . $ship_classku);
try {
	// setting paper
