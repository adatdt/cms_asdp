                                           ...
                                           <div class="input-group pad-top">
                                                <div class="input-group-btn">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a href="javascript:;" onclick="myData.changeSearch('No. Plat','idNumber')" >No. Plat</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!-- /btn-group -->
                                ...
                                <table class="table table-bordered table-hover" id="dataTables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>TOTAL PENUMPANG BOARDING</th>
                                            <!-- <th>PANJANG</th>
                                            <th>TINGGI</th>
                                            <th>LEBAR</th>
                                            <th>BERAT</th> -->
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#download_excel").click(function(event){
            ...
            window.location.href="<?php echo site_url('transaction/boarding_vehicle/download_excel?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port="+port+"&searchData="+searchData+"&searchName="+searchName+"&vehicleClass="+vehicleClass;
        });
