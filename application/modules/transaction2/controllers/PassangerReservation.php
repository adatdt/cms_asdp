...
class PassangerReservation extends MY_Controller{
	public function __construct(){
		parent::__construct();

        logged_in();
        $this->load->model('passangerReservationModel','passanger');
        $this->load->model('global_model');
        $this->load->library('log_activitytxt');

        $this->_table    = 'app.t_trx_booking';
        $this->_username = $this->session->userdata('username');
        $this->_module   = 'transaction2/passangerReservation';
	...
	public function index(){   
        ...
        $data = array(
            ...
            'title'    => 'Reservasi Penumpang Online',
            'content'  => 'passangerReservation/index',
    ...
    public function download_excel()
    {
        ...
        $file_name = 'Reservasi Online Keberangkatan '.$dateFrom.' s/d '.$dateTo;
    ...
    public function download_pdf()
    {
        ...
        // echo "hai";
        $this->load->view('passangerReservation/pdf',$data);
