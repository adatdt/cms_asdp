...
<!--                             <?php 
                            ...
                            <?php   if($btn_pdf)
                            {
                                ...
                                $btn_kapal==1?$access2=" id='btndpdf2' ":$access2=" id='btndpbf2' onclick='validation()' "; 


                            ?>

<!--                                 <button class="btn  btn-sm btn-warning " <?php echo $access ?> >Download Pdf</button>
                                <button class="btn  btn-sm btn-warning " <?php echo $access2 ?> >Download summary Pdf</button> -->
...
<script type="text/javascript">
    ...
    $("#btndpdf").click(function(event){
        ...
        window.open("<?php echo site_url('transaction/syahbandar/download_pdf?boarding_code=')?>"+boarding+"&n=normal");
    ...
    $("#btndpdf2").click(function(event){
        ...
        var boarding="<?php echo $code?>";
        window.open("<?php echo site_url('transaction/syahbandar/download_pdf?boarding_code=')?>"+boarding+"&n=summary");
