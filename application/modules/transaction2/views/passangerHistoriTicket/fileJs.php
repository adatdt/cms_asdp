...
class MyData {
    ...
    get loadData(){
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('transaction2/passangerHistoriTicket') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "time_order", "orderable": true, "className": "text-left"},
                    {"data": "refund_time", "orderable": true, "className": "text-left"},
                    {"data": "check_in_time", "orderable": true, "className": "text-left"},
                    {"data": "gate_in_time", "orderable": true, "className": "text-left"},
                    {"data": "boarding_time", "orderable": true, "className": "text-left"},
            ],
            "language": {
                "aria": {
