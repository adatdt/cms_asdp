    ...
    <div class="page-content">
        ...
        <div class="portlet box blue-madison">
            ...
            <div class="portlet-body">
                <form action="<?php echo site_url('port/save'); ?>" method="post"  id="form-input" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="port_name" data-required="1" maxlength="100" class="form-control"/>
                            </div>
                        </div>
						<!--
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="port_city" maxlength="100" data-required="1" class="form-control" />
                            </div>
                        </div>
						-->
						<div class="form-group">
                            ...
                            <div class="col-md-6">
                               <!-- <div class="prov"></div> -->
								<?php echo form_dropdown('prov',$province,'','class="form-control prov" required data-placeholder="Select Province"'); ?>
                            </div>
                        </div>
						<div class="form-group">
                            <label class="control-label col-md-3">
                            ...
                            <div class="col-md-6">
								<select id="city" class="form-control" data-placeholder="Select city" name="city" required ></select>
                            </div>
                        </div>
						<div class="form-group">
                            <label class="control-label col-md-3">
