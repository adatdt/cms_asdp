...
class VehicleTicketExpired extends MY_Controller{
	public function __construct(){
		parent::__construct();

        logged_in();
        $this->load->model('vehicleTicketExpiredModel','vehicle');
	...
	public function index(){   
        ...
        $data = array(
            ...
            'title'    => 'Ticket Expired Kendaraan',
            'content'  => 'vehicleTicketExpired/index',
    ...
    public function download_excel()
    {
        ...
        $file_name = 'Ticket Expired KND Keberangkatan '.$dateFrom.' s/d '.$dateTo;
    ...
    public function download_pdf()
    {
        ...
        // echo "hai";
        $this->load->view('vehicleTicketExpired/pdf',$data);
