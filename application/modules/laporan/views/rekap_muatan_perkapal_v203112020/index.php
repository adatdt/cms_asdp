                ...
                $.ajax({
                    ...
                    success: function(json) {
                        ...
                        if (json.code == 200) {
                            ...
                            bea_pelabuhan = Number(admin_tiket) + Number(jasa_sandar) + Number(jasa_kepil) + Number(jasa_engker);
                            ...
                            html += "<tr><td class='text-center'>c</td><td class='text-left'>Jasa Engker</td><td class='text-right' colspan='3'>" + formatIDR(jasa_engker) + "</td><td></td></tr>";
