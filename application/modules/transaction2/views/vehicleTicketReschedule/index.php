...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#download_excel").click(function(event) {
            ...
            window.location.href = "<?php echo site_url('transaction2/vehicleTicketReschedule/download_excel?') ?>dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&paymentDateFrom=" + paymentDateFrom + "&paymentDateTo=" + paymentDateTo + "&port=" + port + "&route=" + route + "&shipClass=" + shipClass + "&statusReschedule=" + statusReschedule;
        });
        ...
        $("#download_pdf").click(function(event) {
            ...
            window.open("<?php echo site_url('transaction2/vehicleTicketReschedule/download_pdf?') ?>dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&paymentDateFrom=" + paymentDateFrom + "&paymentDateTo=" + paymentDateTo + "&port=" + port + "&route=" + route + "&shipClass=" + shipClass + "&statusReschedule=" + statusReschedule);
        });
