                                ...
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-sm-12 form-inline">
                                            ...
                                            <div class="input-group select2-bootstrap-prepend pad-top">
                                                <div class="input-group-addon">Bank Tujuan</div>
                                ...
                                <table class="table table-bordered table-hover table-striped" id="dataTables">
                                    <thead>
                                        <tr>
                                            ...
                                            <!-- <th>WAKTU APPROVAL <br/>REFUND</th>
                                            <th>WAKTU TRANSFER <br/>REFUND</th> -->
                                            <th>TOTAL BIAYA <br />ADMINISTRASI</th>
                                            <th>BIAYA<br /> ADMINISTRASI<br /> REFUND</th>
                                            <th>BIAYA REFUND</th>
                                            <th>NO REKENING</th>
                                            <th>BANK TUJUAN</th>
                                            <!-- <th>CHARGE TRANSFER <br />BANK</th> -->
                                            <th>PENGEMBALIAN REFUND <br />(Tidak dikurangi Charge Transfer Bank)</th>
                                        </tr>
                                    </thead>
                                    <tfoot></tfoot>
                                </table>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#download_excel").click(function(event) {
            ...
            window.location.href = "<?php echo site_url('transaction2/vehicleTicketRefund/download_excel?') ?>dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&paymentDateFrom=" + paymentDateFrom + "&paymentDateTo=" + paymentDateTo + "&port=" + port + "&route=" + route + "&shipClass=" + shipClass + "&statusRefunded=" + statusRefunded + "&bank=" + bank;
        });
        ...
        $("#download_pdf").click(function(event) {
            ...
            window.open("<?php echo site_url('transaction2/vehicleTicketRefund/download_pdf?') ?>dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&paymentDateFrom=" + paymentDateFrom + "&paymentDateTo=" + paymentDateTo + "&port=" + port + "&route=" + route + "&shipClass=" + shipClass + "&statusRefunded=" + statusRefunded + "&bank=" + bank);
        });
