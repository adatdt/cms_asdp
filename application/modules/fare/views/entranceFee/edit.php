...
<div class="col-md-6 col-md-offset-3">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('fare/entranceFee/action_edit', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <?= form_dropdown("passangerType",$passangerType,$passangerTypeSelected,' class="form-control select2" id="passangerType" required ') ?>
                        </div>
