...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#download_excel").click(function(event){
            ...
            window.location.href="<?php echo site_url('transaction2/passangerReservation/download_excel?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port="+port+"&route="+route+"&shipClass="+shipClass+"&channel="+channel+"&search="+search;
        });
        ...
        $("#download_pdf").click(function(event){
            ...
            window.open("<?php echo site_url('transaction2/passangerReservation/download_pdf?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port="+port+"&route="+route+"&shipClass="+shipClass+"&channel="+channel+"&search="+search);
        });        
