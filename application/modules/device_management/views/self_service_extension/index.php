                            ...
                            <div class="col-md-12"> 
                                ...
                                <div class="input-group pad-top">
                                    <div class="input-group-btn">
                                        <button type="button" class="btn green dropdown-toggle" data-toggle="dropdown" aria-expanded="false" id='btnData' >Username Phone
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="javascript:;" onclick="changeSearch('Extension Phone','extensionPhone')">Extension Phone</a>
                                            </li>                                                        
                                            <li>
                                                <a href="javascript:;" onclick="changeSearch('Digunakan Oleh','used')">Digunakan Oleh</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- /btn-group -->
                                    <input type="text" class="form-control" placeholder="Cari Data" data-name="usernamePhone" name="searchData" id="searchData"> 
                                </div>                          
...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('device_management/self_service_extension') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "username_phone", "orderable": false, "className": "text-left"},
                    {"data": "extension_phone", "orderable": false, "className": "text-left"},
                    {"data": "password_phone", "orderable": false, "className": "text-left"},
                    {"data": "used_by", "orderable": false, "className": "text-center"},
