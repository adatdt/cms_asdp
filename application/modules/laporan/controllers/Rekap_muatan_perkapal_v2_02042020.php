...
class Rekap_muatan_perkapal_v2 extends MY_Controller {
	...
	public function index(){
		...
		$data = array(
            ...
            'ship_company'  => $this->global_model->select_data("app.t_mtr_ship_company","where status in (1) order by name asc")->result(),
    ...
    public function detail(){
        ...
        $penumpang = $this->rekap_muatan->get_passanger($port, $ship_company, $ship_name, $ship_class, $datefrom, $dateto, $dock_id, $shift);
        $kendaraan = $this->rekap_muatan->get_vehicle($port, $ship_company, $ship_name, $ship_class, $datefrom, $dateto, $dock_id, $shift);
        $dock_fare = $this->rekap_muatan->dock_fare($port, $ship_company, $ship_name, $ship_class, $datefrom, $dateto, $dock_id, $shift);
        $jasa_engker = $this->rekap_muatan->jasa_engker($port, $ship_company, $ship_name, $ship_class, $datefrom, $dateto, $dock_id, $shift);
    ...
    function get_excel()
    {
        ...
        $writer->writeSheetRow($sheet1, array("CABANG",$cabang,"","TANGGAL",format_date($datefrom) . " - " . format_date($dateto)));
