...
<page backtop="30mm" backbottom="10mm" backleft="8mm" backright="8mm">
	...
	<table class="tabel full-width" align="center">
		...
		<tr>
			<td style="border-right: none !important;width: 25%">TIPE TIKET</td>
			<td style="border-left: none !important;width: 25%" colspan="3">: <?=$tipe_tiket ?></td>
		</tr>
	</table>
	...
	<table class="tabel full-width" style="width: 100% !important">
		...
		<tr>
			...
			<td style="text-align: right"><b><?=idr_currency($produksi_tunai+$produksi_cashless+$produksi_online+$produksi_ifcs+$produksi_ifcs_redeem+$produksi_b2b) ?></b></td>
			<td style="text-align: right"><b><?=idr_currency($pendapatan_tunai+$pendapatan_cashless+$pendapatan_online+$pendapatan_ifcs+$pendapatan_ifcs_redeem+$pendapatan_b2b) ?></b></td>
		</tr>
	</table><br>
