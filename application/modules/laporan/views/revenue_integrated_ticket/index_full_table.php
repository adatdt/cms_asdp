    ...
    loadData: function() {
        ...
        $('#tblshipincome').DataTable({
            ...
            "columns": [
                ...
                {"data": "tarif","orderable":true,"className": "text-right", "render": $.fn.dataTable.render.number( '.', ',', 0, '' )},
                {"data": "jumlah","orderable":true,"className": "text-right sum", "render": $.fn.dataTable.render.number( '.', ',', 0, '' )},
                // { "data": null,
