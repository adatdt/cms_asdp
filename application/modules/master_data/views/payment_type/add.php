                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            <div class="input-group">
                                <div class="icheck">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                        <input type="checkbox" class="allow" name='status_web_cs' data-checkbox="icheckbox_flat-grey"  value="yes"> Status Web CS
                                    </label>
                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            <div class="input-group">
                                <div class="icheck">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label>
                                        <input type="checkbox" class="allow" name='status_b2b' data-checkbox="icheckbox_flat-grey"  value="yes"> Status B2B
                                    </label>                                    
