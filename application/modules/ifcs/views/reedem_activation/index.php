                        ...
                        <div class="row">
                            <div class="col-sm-12 form-inline">
                                ...
                                <div class="input-group select2-bootstrap-prepend">
                                    ...
                                    <?php echo form_dropdown("vehicle_class",$vehicle_class,"",' id="vehicle_class" class="form-control js-data-example-ajax select2 input-small"  ')?>
...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('ifcs/reedem_activation') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    // {"data": "is_reedem", "orderable": true, "className": "text-center"},
                    {"data": "is_redeem", "orderable": true, "className": "text-center"},                
