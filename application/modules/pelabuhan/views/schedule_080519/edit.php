                 ...
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <select class="form-control select2" required name="ship" id="ship">
                                    <option value="">Pilih</option>
                        ...
                        <div class="col-sm-4 form-group">
                            <label>Tanggal Jam Buka Layanan <span class="wajib">*</span></label>
                                <input type="text" name="open_boarding" class="form-control waktu" placeholder="YYYY-MM-DD HH:MM" required value="<?php echo $detail->open_boarding_on ?>">
                                <!-- <span class="input-group-addon"><i class="icon-calendar"></i></span> -->

                        </div>

                        <div class="col-sm-4 form-group">
                            <label>Jam Tutup Layanan <span class="wajib">*</span></label>
                                <input type="text" name="close_boarding" class="form-control waktu" required placeholder="YYYY-MM-DD HH:MM" value="<?php echo $detail->close_boarding_on ?>">
                                <!-- <span class="input-group-addon"><i class="icon-calendar"></i></span> -->
                        ...
                        <div class="col-sm-4 form-group">
                            <label>Jam Tutup Ramdoor <span class="wajib">*</span></label>
                                <input type="text" name="close_ramdoor" class="form-control waktu" required placeholder="YYYY-MM-DD HH:MM" value="<?php echo $detail->close_rampdoor_on ?>">
                                <!-- <span class="input-group-addon"><i class="icon-calendar"></i></span> -->
                        ...
                        <div class="col-sm-4 form-group">
                            <label>Tanggal Keberangkatan <span class="wajib">*</span></label>
                                ...
                                <input type="text" name="sail_time" class="form-control waktu" required placeholder="YYYY-MM-DD HH:MM" value="<?php echo $detail->sail_time ?>">
                                <!-- <span class="input-group-addon"><i class="icon-calendar"></i></span> -->
