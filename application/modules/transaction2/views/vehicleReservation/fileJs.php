...
class MyData {
    ...
    get loadData(){
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('transaction2/vehicleReservation') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "length_vehicle", "orderable": true, "className": "text-left"},
                    ...
                    {"data": "invoice_number", "orderable": true, "className": "text-left"},
                    {"data": "sales_channel", "orderable": true, "className": "text-left"},
                    {"data": "transfer_dana", "orderable": true, "className": "text-right"},
            ],
            "language": {
                "aria": {
