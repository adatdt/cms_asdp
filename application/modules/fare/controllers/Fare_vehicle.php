...
class Fare_vehicle extends MY_Controller{
    ...
    public function action_add()
    {
        ...
        $this->form_validation->set_rules('type', 'Tipe Kendaraan', 'trim|required');
        ...
        else 
        {
            ...
            $_POST['route'] = $route_id;
            $_POST['type'] = $vehicle_class;
            $_POST['ship_type'] = $ship_type_id;            
