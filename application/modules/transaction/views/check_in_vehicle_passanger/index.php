                                           ...
                                           <div class="input-group pad-top">
                                                <div class="input-group-btn">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a href="javascript:;" onclick="myData.changeSearch('No. Polisi','identityNumber')" >No. Polisi</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!-- /btn-group -->
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#download_excel").click(function(event){
            ...
            window.location.href="<?php echo site_url('transaction/check_in_vehicle_passanger/download_excel?') ?>dateFrom="+dateFrom+"&dateTo="+dateTo+"&port="+port+"&searchData="+searchData+"&searchName="+searchName;
        });
