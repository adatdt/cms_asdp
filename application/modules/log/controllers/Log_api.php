...
class Log_api extends MY_Controller{
    ...
    public function readFile(){
        ...
        $name_file = 'log_api_'.$get_tanggal.'_'.$get_bulan.'_'.$get_tahun.'.log';
        // $filedir = $dir_file.$name_file;
        $url_base = str_replace('asdp_admin/','asdp_api/',base_url());
        // $filedir = $url_base.$dir_file.$name_file;
        $filedir = '../asdp_api/'.$dir_file.$name_file;
        $data = array();
        ...
        if(file_exists($filedir)){
            ...
            foreach($file as $line_num => $line){
                ...
                if($to_array[0] > 1){
                    ...
                    $data_send['response'] = $to_array[5];
                    $data_send['param'] = $to_array[4];
                    $data[] = $data_send;
                }
