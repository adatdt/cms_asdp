 ...
 <table class="my-table font-small" border="1" >
    ...
    ?>        
            <tr>
                ...
                <td><?php echo  wordwrap($paymentDate, 10, '<br />', true)  ?></td>
                <td><?php echo  wordwrap($departDate, 18, '<br />', true) ?></td>
                <td><?php echo  $value->route_name ?></td>
                <td><?php echo  wordwrap($value->description, 10, '<br />', true)  ?></td>
                <td><?php echo  wordwrap($time_order, 10, '<br />', true)  ?></td>
                <td><?php echo  wordwrap($refund_time, 10, '<br />', true)  ?></td>
                <td><?php echo  wordwrap($check_in_time, 10, '<br />', true)  ?></td>
                <td><?php echo  wordwrap($gate_in_time, 10, '<br />', true)  ?></td>
                <td><?php echo  wordwrap($boarding_time, 10, '<br />', true)  ?></td>
            </tr>  
