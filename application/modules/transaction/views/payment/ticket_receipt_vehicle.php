...
<footer>
    ...
    <div class="border-radius" >
        <table id="mytable-information" cellspacing="0"> 
            ...
            <tr> 
                <td class="alt"><?= ucwords(strtolower($vehicle[0]->customer_name)) ?></td> 
    ...
    <div class="border-radius" >
        ...
        ?>
            <tr> 
                <td class="alt"><?= ucwords(strtolower($vehicle[0]->origin)) ?>, <?= ucwords(strtolower($vehicle[0]->origin_city)) ?></td> 
                <td class="alt"><?= ucwords(strtolower($vehicle[0]->destination)) ?>, <?= ucwords(strtolower($vehicle[0]->destination_city)) ?></td> 
    ...
    <p style="font-size:10px; margin-top: -15px;">Tanggal Pemesanan : <?php echo date("d-m-Y  H:i", strtotime($vehicle[0]->created_payment) )?></p></p>
    ...
    <table id="mytable" cellspacing="0"> 
        ...
        <tr> 
            ...
            <td class="alt">1</td> 
            <!-- <td class="alt">Rp<?=number_format($vehicle[0]->fare,0,',','.')?></td> 
            <td class="alt">Rp<?=number_format($vehicle[0]->fare,0,',','.')?></td>  -->
    ...
    <table id="mytable-prince" cellspacing="0" style=" margin-top: 5px;"> 
        <tr> 
            ...
            <th width="132">Rp<?=number_format($vehicle[0]->amount_invoice,0,',','.')?></th>  
        </tr> 
        <tr> 
            <th>Reduksi</th>  
            <th>-</th>  
        ...
        <tr> 
            ...
            <th  width="287">PPN Fasilitas Yang Dibebaskan <br> <i style="color:#5b5c5b; font-size:10px; " ><?= $ppnText; ?></i></th>  
            <th>Rp<?=number_format(($vehicle[0]->amount_invoice/100)*$ppnReceipt,0,',','.')?></th>  
        </tr> 
        <?php 
            $nameAccount = $vehicle[0]->virtual_account ;
            $virtualAccount ='';
    ...
    <table id="mytable-total-payment" cellspacing="0" style=" margin-top: -58px;"> 
        <tr> 
            ...
            <th width="132" class="spec">Rp<?=number_format($vehicle[0]->amount_payment,0,',','.')?></th>  
        </tr>
    </table>
</body>
</html>