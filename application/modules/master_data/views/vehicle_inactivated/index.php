                    		...
                    		<div class="col-sm-12">
                    			...
                    			<div class="col col-md-3">
                    				<div class="input-group select2-bootstrap-prepend">
                    					...
                    					<select id="vehicle_class_id" class="form-control js-data-example-ajax select2 input-small" dir="" name="vehicle_class_id">
                    						<option value="">Pilih</option>
...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('master_data/vehicle_inactivated') ?>",
                "type": "POST",
                "data": function(d) {
                    d.port_id = document.getElementById('port_id').value;
                    d.vehicle_class_id = document.getElementById('vehicle_class_id').value;
            ...
            "columns": [
                    ...
                    {"data": "group", "orderable": false, "className": "text-center"},
                    ...
                    // {"data": "pos_motor_bike", "orderable": false, "className": "text-center"},
                    // {"data": "pos_vehicle", "orderable": false, "className": "text-center"},
                    ...
                    // {"data": "web_admin", "orderable": false, "className": "text-center"},
                    // {"data": "mpos_vehicle", "orderable": false, "className": "text-center"},
                    // {"data": "mpos_motor_bike", "orderable": false, "className": "text-center"},
...
jQuery(document).ready(function () {
    ...
    $("#vehicle_class_id").on("change",function(){
        table.reload();
    });
