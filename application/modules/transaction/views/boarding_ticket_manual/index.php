            ...
            <div class="portlet box blue-madison">
                <div class="portlet-title">
                    ...
                    <div class="pull-right btn-add-padding" style="padding-left: 5px">
                        <button onclick="showModal('<?= site_url() ?>transaction/boarding_ticket_manual/upload_excel')" class="btn btn-sm btn-warning" title="Import Data"><i class="fa fa-plus"></i> Import Data</button>
                    </div>
                    ...
                    <div class="pull-right btn-add-padding" style="padding-left: 5px">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="<?php echo  base_url() ?>template_excel/ticket_sobek_boarding_kendaraan.xlsx" >Form Input Kendaraan</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url() ?>template_excel/ticket_sobek_boarding_penumpang.xlsx" >Form Input Penumpang</a>
                                </li>
                            </ul>
                        </div>                        
                        ...
                        <div class="kt-portlet__body">
                            <ul class="nav nav-tabs " role="tablist">
                                <li class="nav-item active">
                                        <a class="label label-primary " data-toggle="tab" href="#tab1">Penumpang</a>
                                </li>
                                <li class="nav-item">
                                        <a class="label label-primary " data-toggle="tab" href="#tab2">Kendaraan</a>
                                </li>
                            </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 form-inline">
                                                ...
                                                <div class="input-group select2-bootstrap-prepend pad-top">
                                                    ...
                                                    <?php echo form_dropdown("port",$port,"",'id="port" class="form-control js-data-example-ajax select2 input-small"  ') ?>
                                                </div>

                                                <div class="input-group select2-bootstrap-prepend pad-top">
                                                    <div class="input-group-addon">Shift</div>
                                                    <?php echo form_dropdown("shift",$shift,"",'id="shift" class="form-control js-data-example-ajax select2 input-small" ') ?>

                                                </div>   

                                                <div class="input-group select2-bootstrap-prepend pad-top">
                                                    <div class="input-group-addon">Layanan</div>
                                                    <?php echo form_dropdown("ship_class",$ship_class,"",'id="ship_class" class="form-control js-data-example-ajax select2 input-small" ') ?>
                                                </div>

                                                <div class="input-group select2-bootstrap-prepend">
                                                    <div class="input-group-addon">Status Boarding</div>
                                                    <?= form_dropdown("statusBoarding",$statusBoarding,"",' id="statusBoarding" class="form-control select2"' ) ?>
                                                </div>
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-sm-12 form-inline">
                                                ...
                                                <div class="input-group select2-bootstrap-prepend pad-top">
                                                    <div class="input-group-addon">Pelabuhan</div>
                                                    <?php echo form_dropdown("port2",$port,"",'id="port2" class="form-control js-data-example-ajax select2 input-small" dir="" name="port2" ') ?>
                                                </div>

                                                <div class="input-group select2-bootstrap-prepend pad-top">
                                                    <div class="input-group-addon">Shift</div>
                                                    <?php echo form_dropdown("shift2",$shift,"",'id="shift2" class="form-control js-data-example-ajax select2 input-small" dir="" name="shift2" ') ?>

                                                </div>   

                                                <div class="input-group select2-bootstrap-prepend pad-top">
                                                    <div class="input-group-addon">Layanan</div>
                                                    <?php echo form_dropdown("ship_class2",$ship_class,"",'id="ship_class2" class="form-control js-data-example-ajax select2 input-small" dir="" name="ship_class2" ') ?>
                                                </div> 

                                                <div class="input-group select2-bootstrap-prepend">
                                                    <div class="input-group-addon">Status Boarding</div>
                                                    <?= form_dropdown("statusBoarding2",$statusBoarding,"",' id="statusBoarding2" class="form-control select2"' ) ?>
                                                </div>
                                                ...
                                                <div class="input-group pad-top">
                                                        <div class="input-group-btn">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    <a href="javascript:;" onclick="myData.changeSearch2('Plat Nomor','platNumber')">Plat Nomor</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <!-- /btn-group -->
