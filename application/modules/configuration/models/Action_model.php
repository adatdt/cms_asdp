...
class Action_model extends CI_Model {
    ...
    public function groupList(){
		...
		$sql  		   = "SELECT id, action_name FROM core.t_mtr_menu_action {$where}";
		...
		foreach ($rows_data as $row) {
			...
			$row->id 	= $this->enc->encode($row->id);
     		...
     		$check 		= $this->global_model->checkData('core.t_mtr_menu_detail_web',array('action_id' => $this->enc->decode($row->id)));
