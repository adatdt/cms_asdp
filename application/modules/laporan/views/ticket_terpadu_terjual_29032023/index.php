									...
									<div class="form-group">
										<div class="input-group">
											...
											<select id="payment_type" class="form-control select2" dir="" name="payment_type">
												...
												<option value="ifcs_reedem">IFCS Redeem</option>
				...
				success: function(json) {
					...
					if (json.code == 200) {
						if (json.payment_type == "all") {
							...
							<td style="border-left: none !important;">: ${inMerchant.toUpperCase()}</td>`;
							...
							var hkb = `
							<td style="border-right: none !important;">STATUS</td>
							<td style="border-left: none !important;" ${remCol}>: <b><span id="status_report">${status_report.toUpperCase()}</b></span></td> 
							${ketMer}
							`;
							$("#ketBottom").html(hkb);
							...
							html += "<tr><td colspan='3'> <b>TOTAL JUMLAH (Tunai )</b></td><td class='text-right'>" + formatIDR(jumlah_produksi) + "</td><td class='text-right'>" + formatIDR(jumlah_pendapatan) + "</td></tr>";
							...
							$("#kelaskuu").html(kelaskuu.toUpperCase());
							$("#lintasanku").html(": " + lintasanku.toUpperCase());
						} else if (json.payment_type == "ifcs_reedem") {
							html = "<table class='tabel tabel-no-border'>";
							html += "<tr><th colspan='5'>TIPE PENJUALAN : IFCS Redeem</th><tr>";
							html += "<tr>";
							html += "<td class='text-center'> No </td>";
