...
class VehicleUnderPaid extends MY_Controller{
	public function __construct(){
		parent::__construct();

        logged_in();
        $this->load->model('vehicleUnderPaidModel','vehicle');
	...
	public function index(){   
        ...
        $data = array(
            ...
            'title'    => 'Golongan Kendaraan Kurang Bayar',
            'content'  => 'vehicleUnderPaid/index',
