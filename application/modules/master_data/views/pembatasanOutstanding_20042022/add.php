                 ...
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            <input type="text" id="dateFrom"  name="startDate" class="form-control " required placeholder="YYYY-MM-DD HH:MM" readonly >                       
                        </div>

                        <div class="col-sm-3 form-group">
                            <label>Tanggal Akhir<span class="wajib">*</span></label> 
                            <input type="text" id="dateTo" name="endDate" class="form-control " required placeholder="YYYY-MM-DD HH:MM" readonly >                       
                        </div>
