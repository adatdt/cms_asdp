...
<page backtop="27mm" backbottom="8mm" backleft="0mm" backright="0mm">
    ...
    <table class="tabel full-width" align="left" style="width: 100%">
        <tr>
            ...
            <th class="center bold" rowspan=2 style="width: 2%">NAMA PERUSAHAAN</th>
            <th class="center bold" rowspan=2 style="width: 5%">NAMA KAPAL</th>
            <th class="center bold" rowspan=2 style="width: 5%">TRIP</th>
            <th class="center bold" style="width: 49%" colspan=<?= count($data['dock']) ?> >PENDAPATAN JASA TAMBAT PER DERMAGA</th>
        ...
        <tr>
            ...
            <?php
                ...
                foreach($data['all_data'] as $y => $value) {
                    ...
                    echo '<td class="left">'.wordwrap( $value->company, 40, '<br />', true).'</td>';
                    // echo '<td class="left">'.$value->company.'</td>';
        ...
        <tr>
            <th class="center bold" colspan=3>JUMLAH</th>
...
$filename = strtoupper('laporan_jasa_tambat_'. $pelabuhan . "_" . trim($tanggal));
try
{
  // setting paper
