                                ...
                                <div class="col-md-3" style="padding-right: 0px;">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select id="company" class="form-control js-data-example-ajax select2" dir="">
                                                <option value="">Semua</option>
                                ...
                                <div class="col-md-3" style="padding-right: 0px;">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select id="ship" class="form-control js-data-example-ajax select2" dir="">
                                                <option value="">Semua</option>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        $("#port").change(function() {
            $.ajax({
                method: "GET",
                url: "rekap_muatan_perkapal_new/get_dock/"+$("#port").val(),
                type: "html"
            })
            .done(function( msg ) {
                $("#dock").html(msg);
        ...
        $("#company").change(function() {
            $.ajax({
                method: "GET",
                url: "rekap_muatan_perkapal_new/get_ship/"+$("#company").val(),
                type: "html"
            })
            .done(function( msg ) {
                $("#ship").html(msg);
        ...
        $("#printerkita").on("click",function(e){
            ...
            window.location = "<?php echo site_url('laporan/rekap_muatan_perkapal_new/get_pdf?port=') ?>"+port+
            "&datefrom=" +datefrom+
            "&dateto=" +dateto+
            "&shift="+shift+
        ...
        $("#excelkita").on("click",function(e){
            ...
            window.location = "<?php echo site_url('laporan/rekap_muatan_perkapal_new/get_excel?port=') ?>"+port+
            "&datefrom=" +datefrom+
            "&dateto=" +dateto+
            "&shift="+shift+
            "&ship_class="+ship_class+
        ...
        $("#cari").on("click",function(e){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('laporan/rekap_muatan_perkapal_new/detail') ?>",
                dataType: 'json',
                data: { 
                    port: $("#port").val(),
                    ship_company: $("#company").val(),
            ...
            success: function(json) {
                ...
                if (json.code == 200) {
                    ...
                    html += "</table>";
                    html += "<table>";
                    html += "<tr><td colspan='3' class='text-center'><b>Sub Jumlah</b></td><td class='text-right'>" +formatIDR(total_produksi_penumpang)+ "</td><td class='text-right'>" +formatIDR(total_pendapatan_penumpang)+ "</td><td></td></tr>";
                    ...
                    html += "<tr style='font-size:1em;'><td colspan='3' class='text-center'> <b>Sub Jumlah</b></td><td class='text-right'>" +formatIDR(total_produksi_kendaraan)+ "</td><td class='text-right'>" +formatIDR(total_pendapatan_kendaraan)+ "</td><td></td></tr>";

                    html += "<tr><td colspan='3' class='text-center'> <b>Jumlah (Penumpang + Kendaraan)</b></td><td class='text-right'>" +formatIDR(jumlah_produksi)+ "</td><td class='text-right'>" +formatIDR(jumlah_pendapatan)+ "</td><td></td></tr>";

                    html += "<tr><th colspan='6'>3. BEA JASA PELABUHAN</th><tr>";

                    html += "<tr><td class='text-center'>a</td><td class='text-left'>Jasa Adm. Tiket</td><td class='text-right' colspan='3'>" +formatIDR(admin_tiket)+ "</td><td></td></tr>";

                    html += "<tr><td class='text-center'>b</td><td class='text-left'>Jasa Sandar</td><td class='text-right' colspan='3'>" +formatIDR(jasa_sandar)+ "</td><td></td></tr>";

                    html += "<tr><td class='text-center'>c</td><td class='text-left'>Jasa Kepil</td><td class='text-right' colspan='3'>" +formatIDR(jasa_kepil)+ "</td><td></td></tr>";

                    html += "<tr><td colspan='2' class='text-center'><b>Jumlah</b></td><td class='text-right' colspan='3'>" +formatIDR(bea_pelabuhan)+ "</td><td></td></tr>";
