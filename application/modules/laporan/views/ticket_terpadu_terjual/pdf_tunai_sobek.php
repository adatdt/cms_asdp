...
<page backtop="30mm" backbottom="10mm" backleft="8mm" backright="8mm">
	...
	<table class="tabel full-width" style="width: 100% !important">
		<tr>
			<th colspan="5" style="width: 100%">TIPE PENJUALAN : TUNAI (TIKET SOBEK)</th>
		</tr>
		<tr>
		...
		<?php
			$angka = 1;
			$produksi_tunai_sobek = 0;
			$pendapatan_tunai_sobek = 0;

			foreach ($tunai_sobek as $key => $value) {
				$produksi_tunai_sobek += $value->produksi;
				$pendapatan_tunai_sobek += $value->pendapatan;
				?>
		<tr>
		...
		<tr>
			...
			<td style="text-align: right"><b><?=idr_currency($produksi_tunai_sobek) ?></b></td>
			<td style="text-align: right"><b><?=idr_currency($pendapatan_tunai_sobek) ?></b></td>
		</tr>
		<tr>
			<td colspan="3" style="border-right: 0px;"><b>TOTAL JUMLAH ( Tunai (Tiket Sobek))</b></td>
			<td style="text-align: right"><b><?=idr_currency($produksi_tunai_sobek) ?></b></td>
			<td style="text-align: right"><b><?=idr_currency($pendapatan_tunai_sobek) ?></b></td>
		</tr>
	</table><br>
