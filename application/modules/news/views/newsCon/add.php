...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('news/newsCon/action_add', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="number" min=1 name="ordering" class="form-control" placeholder="urutan" required autocomplete="off">
                        </div>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" name="subTitle" class="form-control" placeholder="Sub Judul Berita" required autocomplete="off">
                        </div>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="videoUrl" name="videoUrl" class="form-control" placeholder="URL Video" autocomplete="off">
                        </div>                        
                        ...
                        <div class="col-md-8 form-group" style="margin-bottom: -4px;">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <label>Thumbnail <span class="wajib">*</span></label>
                        ...
                        <div class="col-sm-12 "></div>
                            ...
                            <div class="col-md-4 form-group">
                                <div class="input-group pad-top">
                                        <!-- <button type="button" class="btn btn-primary mt-ladda-btn ladda-button add-url-image"  max="<?=$maxLinkPicture?>" data-style="zoom-in" id="addRow" > -->
                                        <button type="button" class="btn btn-primary mt-ladda-btn ladda-button add-url-image"  data-style="zoom-in" id="addRow" >
                        ...
                        <div class="col-sm-12 form-group ">
                            <table id="mytable"  align="left" cellspacing="0"> 
                                <tr class="topRow"> 
                                    <th width="5" scope="col" class="spec"></th> 
                                    <th width="750">Link URL Gambar</th>  
                                    <th width="20"></th>
...
<script type="text/javascript">
    ...
    $('#addRow').click(function() {
        let maxPicture = $("#addRow").attr("max");
        let getValue = $("#mytable > tbody > tr ").length ;

        if (parseInt(getValue) > parseInt(maxPicture)){ 

            $("#addRow").prop("disabled",false);
            toastr.error('Tidak boleh melebihi '+ maxPicture +' Inputan');
            
        }else{
            i++;
                $('#mytable').append('<tbody><tr><td scope="row" class="spec" id="row_num' + i + '">' +
                '<input type="hidden" class="form-control imageOrder" name="imageOrder[]" max="' + i + '" readonly></td>' +
