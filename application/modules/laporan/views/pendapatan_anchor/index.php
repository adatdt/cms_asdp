                        ...
                        <div class="col-md-12">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <select id="port" name="port" class="form-control select2 in-group" required data-placeholder="Pilih Pelabuhan">
                                                                <option value=""></option>
                                ...
                                <div id="box">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td class="right-none">TANGGAL</td>
                                            <td class="titik-2">:</td>
                                            <td class="detail left-none" colspan="4" id="tanggal"></td>
                                        </tr>
                                    </table>
