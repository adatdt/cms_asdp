                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="dataTables">
                        <thead>
                            <tr>
                                ...
                                <th>TANGGAL</th>
                                <th>TIPE FORCE MAJEURE</th>
                                <th>KETERANGAN</th>
                                <th>PELABUHAN</th>
                                <th>WAKTU PERPANJANGAN /JAM</th>
                                <th>STATUS</th>
                                <th>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    AKSI
...
var table= {
    loadData: function() {
        $('#dataTables').DataTable({
            "ajax": {
                "url": "<?php echo site_url('transaction/force_majeure') ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [
                    ...
                    {"data": "force_type_name", "orderable": true, "className": "text-left"},
                    {"data": "remark", "orderable": true, "className": "text-left"},
                    {"data": "port_name", "orderable": true, "className": "text-left"},
                    {"data": "extend_param", "orderable": true, "className": "text-center"},
