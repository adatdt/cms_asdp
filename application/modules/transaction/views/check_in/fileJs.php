	...
	class MyData{
	    ...
	    loadData=()=> {
	        $('#dataTables').DataTable({
	            "ajax": {
	                "url": "<?php echo site_url('transaction/check_in') ?>",
	                "type": "POST",
	                "data": function(d) {
	            ...
	            "columns": [
	                    ...
	                    {"data": "booking_channel", "orderable": true, "className": "text-left"},
	                    ...
	                    {"data": "method_checkin", "orderable": true, "className": "text-left"},
