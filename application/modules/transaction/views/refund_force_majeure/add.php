            ...
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            <label > Kode Approval Refund<span class="wajib"> *</span></label>
                            <input type="text" name="approval_code" class="form-control" placeholder="Kode Approval" readonly required>
                        </div>
