...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('transaction/stc/action_open_boarding', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
...
<!--                         <div class="col-sm-6 form-group">
                        ...
                        <div class="col-sm-2 form-group">
                            ...
                            <button  class="btn btn-primary form-control" >Mulai Pelayanan</button>
                        </div>

                        <div class="col-sm-2 form-group">
                            <label>Jam : <?php echo $close_boarding_date; ?></label>
                            <button  class="btn btn-default form-control" disabled >Selesai Pelayanan</button>
                        </div>

                        <div class="col-sm-2 form-group">
                                <label>Jam : <?php echo $close_ramp_door_date; ?></label>
                                <button class="btn btn-default form-control" disabled >Tutup Ramdor</button>
                        </div>
