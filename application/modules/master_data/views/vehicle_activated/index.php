    ...
    loadData: function() {
        $('#dataTables').DataTable({
            ...
            "columns": [
                    ...
                    {"data": "b2b", "orderable": true, "className": "text-left"},
                    {"data": "ifcs", "orderable": true, "className": "text-center"},
                    {"data": "mpos_motor_bike", "orderable": true, "className": "text-center"},
                    {"data": "mpos_vehicle", "orderable": true, "className": "text-center"},
