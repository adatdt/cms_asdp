			...
			<div class="portlet-body">
				<div class="row">
					<div class="col-md-12">
						<div class="table-toolbar" style="margin-bottom: 0px">
							<div class="row">
								...
								<!-- filtering untuk tiket sobek belum naik -->
								<!-- <div class="col-md-2" >
									<div class="form-group">
										<div class="input-group">
											<div class="input-group-addon">TIPE TIKET </div>
											<?= form_dropdown("ticketType",$ticketType,"",' class="form-control js-data-example-ajax select2"  id="ticketType" ') ?>
										</div>
									</div>
								</div> -->
					...
					<div id="master_tabel" style="display: none;">
						...
						<?= generate_button('laporan/produksi_kapal_roro_gs', 'download_pdf', '<button id="printerkita" class="btn btn-sm btn-default"><i class="fa fa-file-pdf-o" style="color: #ea5460"></i> PDF</button>') ?>
						<?= generate_button('laporan/produksi_kapal_roro_gs', 'download_excel', '<button id="excelkita" class="btn btn-sm btn-default"><i class="fa fa-file-excel-o" style="color: #ea5460"></i> EXCEL</button>') ?>
			...
			$.ajax({
				...
				success: function(json) {
					...
					if (json.code == 200) {
						...
						html += "<td class='text-center' colspan='4'> PENUMPANG </td>";
						...
						html += "<td class='text-center'> LANSIA </td>";
						...
						$.each(json.data.all_data, function(i, item) {
							...
							html += "<td class='text-right'>" + format_thousand(item.lansia) + "</td>";
						...
						html += "<td class='text-right'>" + format_thousand(total_lansia) + "</td>";
						...
						var jamku = ": " + json.jam;
						var ticketTypeku =": "+ json.tipeTiket;
