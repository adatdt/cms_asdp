...
<page backtop="22mm" backbottom="-5mm" backleft="-4mm" backright="-4.5mm">
    ...
    <table class="tabel full-width" align="left">
        <tr>
            ...
            <col width="100"><th class="center bold pad-0" rowspan="2">NAMA <br> PERUSAHAAN</th>
            <col width="70"><th class="center bold pad-0" rowspan="2">NAMA <br> KAPAL</th>
            ...
            <th class="center bold" colspan="2">PENUMPANG</th>
        ...
        <tr>
            ...
            <?php
                ...
                foreach($data['all_data'] as $y => $value) {
                    ...
                    echo '<td class="left">'.$value->ship.'</td>';
